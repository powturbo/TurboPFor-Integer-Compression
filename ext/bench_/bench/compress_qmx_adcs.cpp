...
/*
	COMPRESS_QMX_ADCS::COMPRESS_QMX_ADCS()
	----------------------------
*/
ANT_compress_qmx_adcs::ANT_compress_qmx_adcs()
{
length_buffer = NULL;
...
/*
	COMPRESS_QMX_ADCS::ENCODEARRAY()
	---------------------------
*/
void ANT_compress_qmx_adcs::encodeArray(const uint32_t *source, uint64_t source_integers, uint32_t *into, uint64_t *nvalue)
{
...
void ANT_compress_qmx_adcs::decodeArray(const uint32_t *source, uint64_t len, uint32_t *to, uint64_t destination_integers)
{
