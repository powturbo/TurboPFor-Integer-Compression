...
/*
	ANT_ANT_COMPRESS_QMX_V4::ANT_ANT_COMPRESS_QMX_V4()
	------------------------------------
*/
ANT_compress_qmx_v4::ANT_compress_qmx_v4()
{
length_buffer = NULL;
...
/*
	ANT_ANT_COMPRESS_QMX_V4::ENCODEARRAY()
	-------------------------------
*/
void ANT_compress_qmx_v4::encodeArray(const uint32_t *source, uint64_t source_integers, uint32_t *into, uint64_t *nvalue)
{
...
*nvalue = destination - (uint8_t *)into;	// return length in bytes
	...
	/*
		The following program generates the source code for ANT_compress_qmx_v4::decodeArray()
	*/
	/*
		MAIN()
		------
	...
	*/
	...
	for (instance = 0; instance <= 0xFF; instance++)
		{
		printf("\t\tcase 0x%02x:\n", instance);
		printf("\t\t\t_mm_prefetch(keys, _MM_HINT_NTA);\n");
		printf("\t\t\t{\n");
		if ((instance >> 4) == 0)
			{
			/*
			...
			*/
			...
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 6, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 7, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 8, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 9, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 10, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 11, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 12, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 13, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 14, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 15, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 16, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 17, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 18, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 19, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 20, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 21, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 22, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 23, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 24, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 25, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 26, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 27, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 28, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 29, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 30, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 31, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 32, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 33, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 34, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 35, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 36, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 37, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 38, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 39, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 40, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 41, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 42, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 43, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 44, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 45, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 46, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 47, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 48, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 49, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 50, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 51, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 52, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 53, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 54, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 55, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 56, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 57, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 58, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 59, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 60, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 61, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 62, tmp);\n", run * 64);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 63, tmp);\n", run * 64);
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi64(byte_stream, 1), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi64(byte_stream, 2), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi64(byte_stream, 3), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi64(byte_stream, 4), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, _mm_and_si128(_mm_srli_epi64(byte_stream, 5), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 6, _mm_and_si128(_mm_srli_epi64(byte_stream, 6), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 7, _mm_and_si128(_mm_srli_epi64(byte_stream, 7), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 8, _mm_and_si128(_mm_srli_epi64(byte_stream, 8), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 9, _mm_and_si128(_mm_srli_epi64(byte_stream, 9), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 10, _mm_and_si128(_mm_srli_epi64(byte_stream, 10), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 11, _mm_and_si128(_mm_srli_epi64(byte_stream, 11), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 12, _mm_and_si128(_mm_srli_epi64(byte_stream, 12), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 13, _mm_and_si128(_mm_srli_epi64(byte_stream, 13), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 14, _mm_and_si128(_mm_srli_epi64(byte_stream, 14), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 15, _mm_and_si128(_mm_srli_epi64(byte_stream, 15), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 16, _mm_and_si128(_mm_srli_epi64(byte_stream, 16), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 17, _mm_and_si128(_mm_srli_epi64(byte_stream, 17), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 18, _mm_and_si128(_mm_srli_epi64(byte_stream, 18), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 19, _mm_and_si128(_mm_srli_epi64(byte_stream, 19), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 20, _mm_and_si128(_mm_srli_epi64(byte_stream, 20), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 21, _mm_and_si128(_mm_srli_epi64(byte_stream, 21), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 22, _mm_and_si128(_mm_srli_epi64(byte_stream, 22), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 23, _mm_and_si128(_mm_srli_epi64(byte_stream, 23), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 24, _mm_and_si128(_mm_srli_epi64(byte_stream, 24), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 25, _mm_and_si128(_mm_srli_epi64(byte_stream, 25), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 26, _mm_and_si128(_mm_srli_epi64(byte_stream, 26), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 27, _mm_and_si128(_mm_srli_epi64(byte_stream, 27), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 28, _mm_and_si128(_mm_srli_epi64(byte_stream, 28), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 29, _mm_and_si128(_mm_srli_epi64(byte_stream, 29), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 30, _mm_and_si128(_mm_srli_epi64(byte_stream, 30), mask_1));\n", run * 32);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 31, _mm_and_si128(_mm_srli_epi64(byte_stream, 31), mask_1));\n", run * 32);
				printf("}\n");
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi64(byte_stream, 2), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi64(byte_stream, 4), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi64(byte_stream, 6), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi64(byte_stream, 8), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, _mm_and_si128(_mm_srli_epi64(byte_stream, 10), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 6, _mm_and_si128(_mm_srli_epi64(byte_stream, 12), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 7, _mm_and_si128(_mm_srli_epi64(byte_stream, 14), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 8, _mm_and_si128(_mm_srli_epi64(byte_stream, 16), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 9, _mm_and_si128(_mm_srli_epi64(byte_stream, 18), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 10, _mm_and_si128(_mm_srli_epi64(byte_stream, 20), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 11, _mm_and_si128(_mm_srli_epi64(byte_stream, 22), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 12, _mm_and_si128(_mm_srli_epi64(byte_stream, 24), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 13, _mm_and_si128(_mm_srli_epi64(byte_stream, 26), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 14, _mm_and_si128(_mm_srli_epi64(byte_stream, 28), mask_2));\n", run * 16);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 15, _mm_and_si128(_mm_srli_epi64(byte_stream, 30), mask_2));\n", run * 16);
				printf("}\n");
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi64(byte_stream, 3), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi64(byte_stream, 6), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi64(byte_stream, 9), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi64(byte_stream, 12), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, _mm_and_si128(_mm_srli_epi64(byte_stream, 15), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 6, _mm_and_si128(_mm_srli_epi64(byte_stream, 18), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 7, _mm_and_si128(_mm_srli_epi64(byte_stream, 21), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 8, _mm_and_si128(_mm_srli_epi64(byte_stream, 24), mask_3));\n", run * 10);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 9, _mm_and_si128(_mm_srli_epi64(byte_stream, 27), mask_3));\n", run * 10);
				printf("}\n");
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi64(byte_stream, 4), mask_4));\n", run * 8);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi64(byte_stream, 8), mask_4));\n", run * 8);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi64(byte_stream, 12), mask_4));\n", run * 8);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi64(byte_stream, 16), mask_4));\n", run * 8);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, _mm_and_si128(_mm_srli_epi64(byte_stream, 20), mask_4));\n", run * 8);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 6, _mm_and_si128(_mm_srli_epi64(byte_stream, 24), mask_4));\n", run * 8);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 7, _mm_and_si128(_mm_srli_epi64(byte_stream, 28), mask_4));\n", run * 8);
				printf("}\n");
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi64(byte_stream, 5), mask_5));\n", run * 6);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi64(byte_stream, 10), mask_5));\n", run * 6);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi64(byte_stream, 15), mask_5));\n", run * 6);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi64(byte_stream, 20), mask_5));\n", run * 6);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, _mm_and_si128(_mm_srli_epi64(byte_stream, 25), mask_5));\n", run * 6);
				printf("}\n");
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi64(byte_stream, 6), mask_6));\n", run * 5);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi64(byte_stream, 12), mask_6));\n", run * 5);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi64(byte_stream, 18), mask_6));\n", run * 5);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi64(byte_stream, 24), mask_6));\n", run * 5);
				printf("}\n");
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi32(byte_stream, 7), mask_7));\n", run * 9);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi32(byte_stream, 14), mask_7));\n", run * 9);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi32(byte_stream, 21), mask_7));\n", run * 9);

				printf("\t\t\tconst __m128i byte_stream_2 = _mm_loadu_si128((__m128i *)in);\n");
				printf("\t\t\t_mm_prefetch(in += 16, _MM_HINT_NTA);\n");
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 3), mask_7));\n", run * 9);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 6, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 10), mask_7));\n", run * 9);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 7, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 17), mask_7));\n", run * 9);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 8, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 24), mask_7));\n", run * 9);
				printf("}\n");
				printf("\n");
				}
         ...
         */
         for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
            ...
            printf("\t\t\t _mm_storeu_si128((__m128i *)to + %d + 1, _mm_cvtepu8_epi32(_mm_castps_si128(_mm_shuffle_ps(_mm_castsi128_ps(tmp), _mm_castsi128_ps(tmp), 0x01))));\n", run * 4);
            printf("\t\t\t const __m128i tmp3 = _mm_castps_si128(_mm_movehl_ps(_mm_castsi128_ps(tmp), _mm_castsi128_ps(tmp)));\n");
            printf("\t\t\t _mm_storeu_si128((__m128i *)to + %d + 2, _mm_cvtepu8_epi32(tmp3));\n", run * 4);
            printf("\t\t\t _mm_storeu_si128((__m128i *)to + %d + 3, _mm_cvtepu8_epi32(_mm_castps_si128(_mm_shuffle_ps(_mm_castsi128_ps(tmp3), _mm_castsi128_ps(tmp3), 0x01))));\n", run * 4);
				printf("}\n");
            printf("\n");
            }
         ...
         printf("\t\t\tbreak;\n");
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi32(byte_stream, 9), mask_9));\n", run * 7);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi32(byte_stream, 18), mask_9));\n", run * 7);
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 4), mask_9));\n", run * 7);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 5, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 13), mask_9));\n", run * 7);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 6, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 22), mask_9));\n", run * 7);
				printf("}\n");
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t _mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi64(byte_stream, 10), mask_10));\n", run * 3);
				printf("\t\t\t _mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi64(byte_stream, 20), mask_10));\n", run * 3);
				printf("}\n");
				printf("\n");
				}
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_and_si128(_mm_srli_epi32(byte_stream, 12), mask_12));\n", run * 5);
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 3, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 8), mask_12));\n", run * 5);
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 4, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 20), mask_12));\n", run * 5);
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 1, _mm_cvtepu16_epi32(_mm_castps_si128(_mm_movehl_ps(_mm_castsi128_ps(tmp), _mm_castsi128_ps(tmp)))));\n", 2 * run);
			...
			*/
			for (uint32_t run = 0; run < 0x10 - (instance & 0x0F); run++)
				...
				printf("\t\t\t_mm_storeu_si128((__m128i *)to + %d + 2, _mm_and_si128(_mm_srli_epi32(byte_stream_2, 11), mask_21));\n", run * 3);
			...
			*/
			if ((instance & 0x0C) == 0x00)
				{
				for (uint32_t run = 0; run < 0x04 - (instance & 0x03); run++)
					{
					printf("\t\t\t_mm_prefetch(in + %d, _MM_HINT_NTA);\n", run + 1);
					printf("\t\t\t*(to + %d) = *(uint8_t *)(in + %d);\n", run, run);
					}
				printf("\t\t\tin += %d;\n", 0x04 - (instance & 0x03));			// 1 byte integer
				printf("\t\t\tto += %d;\n", 0x04 - (instance & 0x03));			// becomes 1 integer
				}
			else if ((instance & 0x0C) == 0x04)
				{
				for (uint32_t run = 0; run < 0x04 - (instance & 0x03); run++)
					{
					printf("\t\t\t_mm_prefetch(in + 2 * %d, _MM_HINT_NTA);\n", run + 1);
					printf("\t\t\t*(to + %d) = *(uint16_t *)(in + 2 * %d);\n", run, run);
					}
				printf("\t\t\tin += 2 * %d;\n", 0x04 - (instance & 0x03));			// 2 byte integers
				printf("\t\t\tto += %d;\n", 0x04 - (instance & 0x03));			// becomes 1 integer
				}
				...
				for (uint32_t run = 0; run < 0x04 - (instance & 0x03); run++)
					{
					printf("\t\t\t_mm_prefetch(in + 3 * %d, _MM_HINT_NTA);\n", run + 1);
					printf("\t\t\t*(to + %d) = (*(uint8_t *)(in + 3 * %d) << 16) | (*(uint8_t *)(in + 3 * %d + 1) << 8) | (*(uint8_t *)(in + 3 * %d + 2));\n", run, run, run, run);
					}
				printf("\t\t\tin += 3 * %d;\n", 0x04 - (instance & 0x03));			// 3 byte integer
				printf("\t\t\tto += %d;\n", 0x04 - (instance & 0x03));			// becomes 1 integer
				}
				...
				for (uint32_t run = 0; run < 0x04 - (instance & 0x03); run++)
					{
					printf("\t\t\t_mm_prefetch(in + 4 * %d, _MM_HINT_NTA);\n", run + 1);
					printf("\t\t\t*(to + %d) = *(uint32_t *)(in + 4 * %d);\n", run, run);
					}
				printf("\t\t\tin += 4 * %d;\n", 0x04 - (instance & 0x03));			// 4 byte integer
				printf("\t\t\tto += %d;\n", 0x04 - (instance & 0x03));			// becomes 1 integer
				}
			printf("\t\t\tbreak;\n");
			}
	...
	*/
	...
	{
  	ANT_compress_qmx_v4 compressor;
...
#endif
/*
	ANT_ANT_COMPRESS_QMX_V4::DECODEARRAY()
	--------------------------------
	this code was generated by the method above.
*/
#include "compress_qmx_v4_decompress.cpp"
