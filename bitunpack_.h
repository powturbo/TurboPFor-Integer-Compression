...
#define BITUNBLK64_1(ip, i, op, parm) {    uint32_t w0 = *(uint32_t *)(ip+(i*1+0)*4/sizeof(ip[0]));\
...
#define BITUNBLK64_2(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*1+0)*8/sizeof(ip[0]));\
...
#define BITUNBLK64_3(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*3+0)*8/sizeof(ip[0]));\
  ...
  OUT(op,i*64+20, (w0 >> 60) & 0x7, parm);   uint64_t w1 = *(uint32_t *)(ip+(i*3+1)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_4(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*1+0)*8/sizeof(ip[0]));\
...
#define BITUNBLK64_5(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*5+0)*8/sizeof(ip[0]));\
  ...
  OUT(op,i*64+11, (w0 >> 55) & 0x1f, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*5+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+24, (w1 >> 56) & 0x1f, parm);   uint64_t w2 = *(uint32_t *)(ip+(i*5+2)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_6(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*3+0)*8/sizeof(ip[0]));\
  ...
  OUT(op,i*32+ 9, (w0 >> 54) & 0x3f, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*3+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*32+20, (w1 >> 56) & 0x3f, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*3+2)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_7(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*7+0)*8/sizeof(ip[0]));\
  ...
  OUT(op,i*64+ 8, (w0 >> 56) & 0x7f, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*7+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+17, (w1 >> 55) & 0x7f, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*7+2)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+26, (w2 >> 54) & 0x7f, parm);   uint64_t w3 = *(uint32_t *)(ip+(i*7+3)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_8(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*1+0)*8/sizeof(ip[0]));\
...
#define BITUNBLK64_9(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*9+0)*8/sizeof(ip[0]));\
  ...
  OUT(op,i*64+ 6, (w0 >> 54) & 0x1ff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*9+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+13, (w1 >> 53) & 0x1ff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*9+2)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+20, (w2 >> 52) & 0x1ff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*9+3)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+27, (w3 >> 51) & 0x1ff, parm);   uint64_t w4 = *(uint32_t *)(ip+(i*9+4)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_10(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*5+0)*8/sizeof(ip[0]));\
  ...
  OUT(op,i*32+ 5, (w0 >> 50) & 0x3ff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*5+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*32+11, (w1 >> 46) & 0x3ff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*5+2)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*32+18, (w2 >> 52) & 0x3ff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*5+3)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*32+24, (w3 >> 48) & 0x3ff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*5+4)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_11(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*11+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7ff, parm);\
  OUT(op,i*64+ 1, (w0 >> 11) & 0x7ff, parm);\
  OUT(op,i*64+ 2, (w0 >> 22) & 0x7ff, parm);\
  OUT(op,i*64+ 3, (w0 >> 33) & 0x7ff, parm);\
  OUT(op,i*64+ 4, (w0 >> 44) & 0x7ff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*11+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+10, (w1 >> 46) & 0x7ff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*11+2)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+16, (w2 >> 48) & 0x7ff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*11+3)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+22, (w3 >> 50) & 0x7ff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*11+4)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+28, (w4 >> 52) & 0x7ff, parm);   uint64_t w5 = *(uint32_t *)(ip+(i*11+5)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_12(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*3+0)*8/sizeof(ip[0]));\
  OUT(op,i*16+ 0, (w0 ) & 0xfff, parm);\
  OUT(op,i*16+ 1, (w0 >> 12) & 0xfff, parm);\
  OUT(op,i*16+ 2, (w0 >> 24) & 0xfff, parm);\
  OUT(op,i*16+ 3, (w0 >> 36) & 0xfff, parm);\
  OUT(op,i*16+ 4, (w0 >> 48) & 0xfff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*3+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*16+ 9, (w1 >> 44) & 0xfff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*3+2)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_13(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*13+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1fff, parm);\
  OUT(op,i*64+ 1, (w0 >> 13) & 0x1fff, parm);\
  OUT(op,i*64+ 2, (w0 >> 26) & 0x1fff, parm);\
  OUT(op,i*64+ 3, (w0 >> 39) & 0x1fff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*13+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+ 8, (w1 >> 40) & 0x1fff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*13+2)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+13, (w2 >> 41) & 0x1fff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*13+3)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+18, (w3 >> 42) & 0x1fff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*13+4)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+23, (w4 >> 43) & 0x1fff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*13+5)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+28, (w5 >> 44) & 0x1fff, parm);   uint64_t w6 = *(uint32_t *)(ip+(i*13+6)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_14(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*7+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3fff, parm);\
  OUT(op,i*32+ 1, (w0 >> 14) & 0x3fff, parm);\
  OUT(op,i*32+ 2, (w0 >> 28) & 0x3fff, parm);\
  OUT(op,i*32+ 3, (w0 >> 42) & 0x3fff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*7+1)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*32+ 8, (w1 >> 48) & 0x3fff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*7+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w1 >> 62) | (w2 <<  2) & 0x3fff, parm);\
  OUT(op,i*32+10, (w2 >> 12) & 0x3fff, parm);\
  OUT(op,i*32+11, (w2 >> 26) & 0x3fff, parm);\
  OUT(op,i*32+12, (w2 >> 40) & 0x3fff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*7+3)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*32+17, (w3 >> 46) & 0x3fff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*7+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w3 >> 60) | (w4 <<  4) & 0x3fff, parm);\
  OUT(op,i*32+19, (w4 >> 10) & 0x3fff, parm);\
  OUT(op,i*32+20, (w4 >> 24) & 0x3fff, parm);\
  OUT(op,i*32+21, (w4 >> 38) & 0x3fff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*7+5)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*32+26, (w5 >> 44) & 0x3fff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*7+6)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_15(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*15+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7fff, parm);\
  OUT(op,i*64+ 1, (w0 >> 15) & 0x7fff, parm);\
  OUT(op,i*64+ 2, (w0 >> 30) & 0x7fff, parm);\
  OUT(op,i*64+ 3, (w0 >> 45) & 0x7fff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*15+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w0 >> 60) | (w1 <<  4) & 0x7fff, parm);\
  OUT(op,i*64+ 5, (w1 >> 11) & 0x7fff, parm);\
  OUT(op,i*64+ 6, (w1 >> 26) & 0x7fff, parm);\
  OUT(op,i*64+ 7, (w1 >> 41) & 0x7fff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*15+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w1 >> 56) | (w2 <<  8) & 0x7fff, parm);\
  OUT(op,i*64+ 9, (w2 >>  7) & 0x7fff, parm);\
  OUT(op,i*64+10, (w2 >> 22) & 0x7fff, parm);\
  OUT(op,i*64+11, (w2 >> 37) & 0x7fff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*15+3)*8/sizeof(ip[0]));\
\
  ...
  OUT(op,i*64+16, (w3 >> 48) & 0x7fff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*15+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w3 >> 63) | (w4 <<  1) & 0x7fff, parm);\
  OUT(op,i*64+18, (w4 >> 14) & 0x7fff, parm);\
  OUT(op,i*64+19, (w4 >> 29) & 0x7fff, parm);\
  OUT(op,i*64+20, (w4 >> 44) & 0x7fff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*15+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w4 >> 59) | (w5 <<  5) & 0x7fff, parm);\
  OUT(op,i*64+22, (w5 >> 10) & 0x7fff, parm);\
  OUT(op,i*64+23, (w5 >> 25) & 0x7fff, parm);\
  OUT(op,i*64+24, (w5 >> 40) & 0x7fff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*15+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w5 >> 55) | (w6 <<  9) & 0x7fff, parm);\
  OUT(op,i*64+26, (w6 >>  6) & 0x7fff, parm);\
  OUT(op,i*64+27, (w6 >> 21) & 0x7fff, parm);\
  OUT(op,i*64+28, (w6 >> 36) & 0x7fff, parm);   uint64_t w7 = *(uint32_t *)(ip+(i*15+7)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_18(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*9+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3ffff, parm);\
  OUT(op,i*32+ 1, (w0 >> 18) & 0x3ffff, parm);\
  OUT(op,i*32+ 2, (w0 >> 36) & 0x3ffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*9+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w0 >> 54) | (w1 << 10) & 0x3ffff, parm);\
  OUT(op,i*32+ 4, (w1 >>  8) & 0x3ffff, parm);\
  OUT(op,i*32+ 5, (w1 >> 26) & 0x3ffff, parm);\
  OUT(op,i*32+ 6, (w1 >> 44) & 0x3ffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*9+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w1 >> 62) | (w2 <<  2) & 0x3ffff, parm);\
  OUT(op,i*32+ 8, (w2 >> 16) & 0x3ffff, parm);\
  OUT(op,i*32+ 9, (w2 >> 34) & 0x3ffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*9+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+10, (w2 >> 52) | (w3 << 12) & 0x3ffff, parm);\
  OUT(op,i*32+11, (w3 >>  6) & 0x3ffff, parm);\
  OUT(op,i*32+12, (w3 >> 24) & 0x3ffff, parm);\
  OUT(op,i*32+13, (w3 >> 42) & 0x3ffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*9+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w3 >> 60) | (w4 <<  4) & 0x3ffff, parm);\
  OUT(op,i*32+15, (w4 >> 14) & 0x3ffff, parm);\
  OUT(op,i*32+16, (w4 >> 32) & 0x3ffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*9+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w4 >> 50) | (w5 << 14) & 0x3ffff, parm);\
  OUT(op,i*32+18, (w5 >>  4) & 0x3ffff, parm);\
  OUT(op,i*32+19, (w5 >> 22) & 0x3ffff, parm);\
  OUT(op,i*32+20, (w5 >> 40) & 0x3ffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*9+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+21, (w5 >> 58) | (w6 <<  6) & 0x3ffff, parm);\
  OUT(op,i*32+22, (w6 >> 12) & 0x3ffff, parm);\
  OUT(op,i*32+23, (w6 >> 30) & 0x3ffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*9+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w6 >> 48) | (w7 << 16) & 0x3ffff, parm);\
  OUT(op,i*32+25, (w7 >>  2) & 0x3ffff, parm);\
  OUT(op,i*32+26, (w7 >> 20) & 0x3ffff, parm);\
  OUT(op,i*32+27, (w7 >> 38) & 0x3ffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*9+8)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_19(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*19+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7ffff, parm);\
  OUT(op,i*64+ 1, (w0 >> 19) & 0x7ffff, parm);\
  OUT(op,i*64+ 2, (w0 >> 38) & 0x7ffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*19+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w0 >> 57) | (w1 <<  7) & 0x7ffff, parm);\
  OUT(op,i*64+ 4, (w1 >> 12) & 0x7ffff, parm);\
  OUT(op,i*64+ 5, (w1 >> 31) & 0x7ffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*19+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w1 >> 50) | (w2 << 14) & 0x7ffff, parm);\
  OUT(op,i*64+ 7, (w2 >>  5) & 0x7ffff, parm);\
  OUT(op,i*64+ 8, (w2 >> 24) & 0x7ffff, parm);\
  OUT(op,i*64+ 9, (w2 >> 43) & 0x7ffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*19+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w2 >> 62) | (w3 <<  2) & 0x7ffff, parm);\
  OUT(op,i*64+11, (w3 >> 17) & 0x7ffff, parm);\
  OUT(op,i*64+12, (w3 >> 36) & 0x7ffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*19+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w3 >> 55) | (w4 <<  9) & 0x7ffff, parm);\
  OUT(op,i*64+14, (w4 >> 10) & 0x7ffff, parm);\
  OUT(op,i*64+15, (w4 >> 29) & 0x7ffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*19+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w4 >> 48) | (w5 << 16) & 0x7ffff, parm);\
  OUT(op,i*64+17, (w5 >>  3) & 0x7ffff, parm);\
  OUT(op,i*64+18, (w5 >> 22) & 0x7ffff, parm);\
  OUT(op,i*64+19, (w5 >> 41) & 0x7ffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*19+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w5 >> 60) | (w6 <<  4) & 0x7ffff, parm);\
  OUT(op,i*64+21, (w6 >> 15) & 0x7ffff, parm);\
  OUT(op,i*64+22, (w6 >> 34) & 0x7ffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*19+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w6 >> 53) | (w7 << 11) & 0x7ffff, parm);\
  OUT(op,i*64+24, (w7 >>  8) & 0x7ffff, parm);\
  OUT(op,i*64+25, (w7 >> 27) & 0x7ffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*19+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w7 >> 46) | (w8 << 18) & 0x7ffff, parm);\
  OUT(op,i*64+27, (w8 >>  1) & 0x7ffff, parm);\
  OUT(op,i*64+28, (w8 >> 20) & 0x7ffff, parm);\
  OUT(op,i*64+29, (w8 >> 39) & 0x7ffff, parm);   uint64_t w9 = *(uint32_t *)(ip+(i*19+9)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_20(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*5+0)*8/sizeof(ip[0]));\
  OUT(op,i*16+ 0, (w0 ) & 0xfffff, parm);\
  OUT(op,i*16+ 1, (w0 >> 20) & 0xfffff, parm);\
  OUT(op,i*16+ 2, (w0 >> 40) & 0xfffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*5+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 3, (w0 >> 60) | (w1 <<  4) & 0xfffff, parm);\
  OUT(op,i*16+ 4, (w1 >> 16) & 0xfffff, parm);\
  OUT(op,i*16+ 5, (w1 >> 36) & 0xfffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*5+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 6, (w1 >> 56) | (w2 <<  8) & 0xfffff, parm);\
  OUT(op,i*16+ 7, (w2 >> 12) & 0xfffff, parm);\
  OUT(op,i*16+ 8, (w2 >> 32) & 0xfffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*5+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 9, (w2 >> 52) | (w3 << 12) & 0xfffff, parm);\
  OUT(op,i*16+10, (w3 >>  8) & 0xfffff, parm);\
  OUT(op,i*16+11, (w3 >> 28) & 0xfffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*5+4)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_21(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*21+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1fffff, parm);\
  OUT(op,i*64+ 1, (w0 >> 21) & 0x1fffff, parm);\
  OUT(op,i*64+ 2, (w0 >> 42) & 0x1fffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*21+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w0 >> 63) | (w1 <<  1) & 0x1fffff, parm);\
  OUT(op,i*64+ 4, (w1 >> 20) & 0x1fffff, parm);\
  OUT(op,i*64+ 5, (w1 >> 41) & 0x1fffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*21+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w1 >> 62) | (w2 <<  2) & 0x1fffff, parm);\
  OUT(op,i*64+ 7, (w2 >> 19) & 0x1fffff, parm);\
  OUT(op,i*64+ 8, (w2 >> 40) & 0x1fffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*21+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w2 >> 61) | (w3 <<  3) & 0x1fffff, parm);\
  OUT(op,i*64+10, (w3 >> 18) & 0x1fffff, parm);\
  OUT(op,i*64+11, (w3 >> 39) & 0x1fffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*21+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w3 >> 60) | (w4 <<  4) & 0x1fffff, parm);\
  OUT(op,i*64+13, (w4 >> 17) & 0x1fffff, parm);\
  OUT(op,i*64+14, (w4 >> 38) & 0x1fffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*21+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w4 >> 59) | (w5 <<  5) & 0x1fffff, parm);\
  OUT(op,i*64+16, (w5 >> 16) & 0x1fffff, parm);\
  OUT(op,i*64+17, (w5 >> 37) & 0x1fffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*21+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w5 >> 58) | (w6 <<  6) & 0x1fffff, parm);\
  OUT(op,i*64+19, (w6 >> 15) & 0x1fffff, parm);\
  OUT(op,i*64+20, (w6 >> 36) & 0x1fffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*21+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w6 >> 57) | (w7 <<  7) & 0x1fffff, parm);\
  OUT(op,i*64+22, (w7 >> 14) & 0x1fffff, parm);\
  OUT(op,i*64+23, (w7 >> 35) & 0x1fffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*21+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w7 >> 56) | (w8 <<  8) & 0x1fffff, parm);\
  OUT(op,i*64+25, (w8 >> 13) & 0x1fffff, parm);\
  OUT(op,i*64+26, (w8 >> 34) & 0x1fffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*21+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w8 >> 55) | (w9 <<  9) & 0x1fffff, parm);\
  OUT(op,i*64+28, (w9 >> 12) & 0x1fffff, parm);\
  OUT(op,i*64+29, (w9 >> 33) & 0x1fffff, parm);   uint64_t w10 = *(uint32_t *)(ip+(i*21+10)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_22(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*11+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3fffff, parm);\
  OUT(op,i*32+ 1, (w0 >> 22) & 0x3fffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*11+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w0 >> 44) | (w1 << 20) & 0x3fffff, parm);\
  OUT(op,i*32+ 3, (w1 >>  2) & 0x3fffff, parm);\
  OUT(op,i*32+ 4, (w1 >> 24) & 0x3fffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*11+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w1 >> 46) | (w2 << 18) & 0x3fffff, parm);\
  OUT(op,i*32+ 6, (w2 >>  4) & 0x3fffff, parm);\
  OUT(op,i*32+ 7, (w2 >> 26) & 0x3fffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*11+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w2 >> 48) | (w3 << 16) & 0x3fffff, parm);\
  OUT(op,i*32+ 9, (w3 >>  6) & 0x3fffff, parm);\
  OUT(op,i*32+10, (w3 >> 28) & 0x3fffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*11+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w3 >> 50) | (w4 << 14) & 0x3fffff, parm);\
  OUT(op,i*32+12, (w4 >>  8) & 0x3fffff, parm);\
  OUT(op,i*32+13, (w4 >> 30) & 0x3fffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*11+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w4 >> 52) | (w5 << 12) & 0x3fffff, parm);\
  OUT(op,i*32+15, (w5 >> 10) & 0x3fffff, parm);\
  OUT(op,i*32+16, (w5 >> 32) & 0x3fffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*11+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w5 >> 54) | (w6 << 10) & 0x3fffff, parm);\
  OUT(op,i*32+18, (w6 >> 12) & 0x3fffff, parm);\
  OUT(op,i*32+19, (w6 >> 34) & 0x3fffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*11+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w6 >> 56) | (w7 <<  8) & 0x3fffff, parm);\
  OUT(op,i*32+21, (w7 >> 14) & 0x3fffff, parm);\
  OUT(op,i*32+22, (w7 >> 36) & 0x3fffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*11+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w7 >> 58) | (w8 <<  6) & 0x3fffff, parm);\
  OUT(op,i*32+24, (w8 >> 16) & 0x3fffff, parm);\
  OUT(op,i*32+25, (w8 >> 38) & 0x3fffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*11+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w8 >> 60) | (w9 <<  4) & 0x3fffff, parm);\
  OUT(op,i*32+27, (w9 >> 18) & 0x3fffff, parm);\
  OUT(op,i*32+28, (w9 >> 40) & 0x3fffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*11+10)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_23(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*23+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7fffff, parm);\
  OUT(op,i*64+ 1, (w0 >> 23) & 0x7fffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*23+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w0 >> 46) | (w1 << 18) & 0x7fffff, parm);\
  OUT(op,i*64+ 3, (w1 >>  5) & 0x7fffff, parm);\
  OUT(op,i*64+ 4, (w1 >> 28) & 0x7fffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*23+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w1 >> 51) | (w2 << 13) & 0x7fffff, parm);\
  OUT(op,i*64+ 6, (w2 >> 10) & 0x7fffff, parm);\
  OUT(op,i*64+ 7, (w2 >> 33) & 0x7fffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*23+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w2 >> 56) | (w3 <<  8) & 0x7fffff, parm);\
  OUT(op,i*64+ 9, (w3 >> 15) & 0x7fffff, parm);\
  OUT(op,i*64+10, (w3 >> 38) & 0x7fffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*23+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w3 >> 61) | (w4 <<  3) & 0x7fffff, parm);\
  OUT(op,i*64+12, (w4 >> 20) & 0x7fffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*23+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w4 >> 43) | (w5 << 21) & 0x7fffff, parm);\
  OUT(op,i*64+14, (w5 >>  2) & 0x7fffff, parm);\
  OUT(op,i*64+15, (w5 >> 25) & 0x7fffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*23+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w5 >> 48) | (w6 << 16) & 0x7fffff, parm);\
  OUT(op,i*64+17, (w6 >>  7) & 0x7fffff, parm);\
  OUT(op,i*64+18, (w6 >> 30) & 0x7fffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*23+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w6 >> 53) | (w7 << 11) & 0x7fffff, parm);\
  OUT(op,i*64+20, (w7 >> 12) & 0x7fffff, parm);\
  OUT(op,i*64+21, (w7 >> 35) & 0x7fffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*23+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w7 >> 58) | (w8 <<  6) & 0x7fffff, parm);\
  OUT(op,i*64+23, (w8 >> 17) & 0x7fffff, parm);\
  OUT(op,i*64+24, (w8 >> 40) & 0x7fffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*23+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w8 >> 63) | (w9 <<  1) & 0x7fffff, parm);\
  OUT(op,i*64+26, (w9 >> 22) & 0x7fffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*23+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w9 >> 45) | (w10 << 19) & 0x7fffff, parm);\
  OUT(op,i*64+28, (w10 >>  4) & 0x7fffff, parm);\
  OUT(op,i*64+29, (w10 >> 27) & 0x7fffff, parm);   uint64_t w11 = *(uint32_t *)(ip+(i*23+11)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_24(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*3+0)*8/sizeof(ip[0]));\
  OUT(op,i*8+ 0, (w0 ) & 0xffffff, parm);\
  OUT(op,i*8+ 1, (w0 >> 24) & 0xffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*3+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 2, (w0 >> 48) | (w1 << 16) & 0xffffff, parm);\
  OUT(op,i*8+ 3, (w1 >>  8) & 0xffffff, parm);\
  OUT(op,i*8+ 4, (w1 >> 32) & 0xffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*3+2)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_25(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*25+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1ffffff, parm);\
  OUT(op,i*64+ 1, (w0 >> 25) & 0x1ffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*25+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w0 >> 50) | (w1 << 14) & 0x1ffffff, parm);\
  OUT(op,i*64+ 3, (w1 >> 11) & 0x1ffffff, parm);\
  OUT(op,i*64+ 4, (w1 >> 36) & 0x1ffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*25+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w1 >> 61) | (w2 <<  3) & 0x1ffffff, parm);\
  OUT(op,i*64+ 6, (w2 >> 22) & 0x1ffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*25+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w2 >> 47) | (w3 << 17) & 0x1ffffff, parm);\
  OUT(op,i*64+ 8, (w3 >>  8) & 0x1ffffff, parm);\
  OUT(op,i*64+ 9, (w3 >> 33) & 0x1ffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*25+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w3 >> 58) | (w4 <<  6) & 0x1ffffff, parm);\
  OUT(op,i*64+11, (w4 >> 19) & 0x1ffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*25+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w4 >> 44) | (w5 << 20) & 0x1ffffff, parm);\
  OUT(op,i*64+13, (w5 >>  5) & 0x1ffffff, parm);\
  OUT(op,i*64+14, (w5 >> 30) & 0x1ffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*25+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w5 >> 55) | (w6 <<  9) & 0x1ffffff, parm);\
  OUT(op,i*64+16, (w6 >> 16) & 0x1ffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*25+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w6 >> 41) | (w7 << 23) & 0x1ffffff, parm);\
  OUT(op,i*64+18, (w7 >>  2) & 0x1ffffff, parm);\
  OUT(op,i*64+19, (w7 >> 27) & 0x1ffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*25+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w7 >> 52) | (w8 << 12) & 0x1ffffff, parm);\
  OUT(op,i*64+21, (w8 >> 13) & 0x1ffffff, parm);\
  OUT(op,i*64+22, (w8 >> 38) & 0x1ffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*25+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w8 >> 63) | (w9 <<  1) & 0x1ffffff, parm);\
  OUT(op,i*64+24, (w9 >> 24) & 0x1ffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*25+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w9 >> 49) | (w10 << 15) & 0x1ffffff, parm);\
  OUT(op,i*64+26, (w10 >> 10) & 0x1ffffff, parm);\
  OUT(op,i*64+27, (w10 >> 35) & 0x1ffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*25+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w10 >> 60) | (w11 <<  4) & 0x1ffffff, parm);\
  OUT(op,i*64+29, (w11 >> 21) & 0x1ffffff, parm);   uint64_t w12 = *(uint32_t *)(ip+(i*25+12)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_26(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*13+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3ffffff, parm);\
  OUT(op,i*32+ 1, (w0 >> 26) & 0x3ffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*13+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w0 >> 52) | (w1 << 12) & 0x3ffffff, parm);\
  OUT(op,i*32+ 3, (w1 >> 14) & 0x3ffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*13+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 4, (w1 >> 40) | (w2 << 24) & 0x3ffffff, parm);\
  OUT(op,i*32+ 5, (w2 >>  2) & 0x3ffffff, parm);\
  OUT(op,i*32+ 6, (w2 >> 28) & 0x3ffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*13+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w2 >> 54) | (w3 << 10) & 0x3ffffff, parm);\
  OUT(op,i*32+ 8, (w3 >> 16) & 0x3ffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*13+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w3 >> 42) | (w4 << 22) & 0x3ffffff, parm);\
  OUT(op,i*32+10, (w4 >>  4) & 0x3ffffff, parm);\
  OUT(op,i*32+11, (w4 >> 30) & 0x3ffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*13+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+12, (w4 >> 56) | (w5 <<  8) & 0x3ffffff, parm);\
  OUT(op,i*32+13, (w5 >> 18) & 0x3ffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*13+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w5 >> 44) | (w6 << 20) & 0x3ffffff, parm);\
  OUT(op,i*32+15, (w6 >>  6) & 0x3ffffff, parm);\
  OUT(op,i*32+16, (w6 >> 32) & 0x3ffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*13+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w6 >> 58) | (w7 <<  6) & 0x3ffffff, parm);\
  OUT(op,i*32+18, (w7 >> 20) & 0x3ffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*13+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+19, (w7 >> 46) | (w8 << 18) & 0x3ffffff, parm);\
  OUT(op,i*32+20, (w8 >>  8) & 0x3ffffff, parm);\
  OUT(op,i*32+21, (w8 >> 34) & 0x3ffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*13+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+22, (w8 >> 60) | (w9 <<  4) & 0x3ffffff, parm);\
  OUT(op,i*32+23, (w9 >> 22) & 0x3ffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*13+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w9 >> 48) | (w10 << 16) & 0x3ffffff, parm);\
  OUT(op,i*32+25, (w10 >> 10) & 0x3ffffff, parm);\
  OUT(op,i*32+26, (w10 >> 36) & 0x3ffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*13+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+27, (w10 >> 62) | (w11 <<  2) & 0x3ffffff, parm);\
  OUT(op,i*32+28, (w11 >> 24) & 0x3ffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*13+12)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_27(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*27+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7ffffff, parm);\
  OUT(op,i*64+ 1, (w0 >> 27) & 0x7ffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*27+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w0 >> 54) | (w1 << 10) & 0x7ffffff, parm);\
  OUT(op,i*64+ 3, (w1 >> 17) & 0x7ffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*27+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w1 >> 44) | (w2 << 20) & 0x7ffffff, parm);\
  OUT(op,i*64+ 5, (w2 >>  7) & 0x7ffffff, parm);\
  OUT(op,i*64+ 6, (w2 >> 34) & 0x7ffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*27+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w2 >> 61) | (w3 <<  3) & 0x7ffffff, parm);\
  OUT(op,i*64+ 8, (w3 >> 24) & 0x7ffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*27+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w3 >> 51) | (w4 << 13) & 0x7ffffff, parm);\
  OUT(op,i*64+10, (w4 >> 14) & 0x7ffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*27+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w4 >> 41) | (w5 << 23) & 0x7ffffff, parm);\
  OUT(op,i*64+12, (w5 >>  4) & 0x7ffffff, parm);\
  OUT(op,i*64+13, (w5 >> 31) & 0x7ffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*27+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w5 >> 58) | (w6 <<  6) & 0x7ffffff, parm);\
  OUT(op,i*64+15, (w6 >> 21) & 0x7ffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*27+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w6 >> 48) | (w7 << 16) & 0x7ffffff, parm);\
  OUT(op,i*64+17, (w7 >> 11) & 0x7ffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*27+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w7 >> 38) | (w8 << 26) & 0x7ffffff, parm);\
  OUT(op,i*64+19, (w8 >>  1) & 0x7ffffff, parm);\
  OUT(op,i*64+20, (w8 >> 28) & 0x7ffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*27+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w8 >> 55) | (w9 <<  9) & 0x7ffffff, parm);\
  OUT(op,i*64+22, (w9 >> 18) & 0x7ffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*27+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w9 >> 45) | (w10 << 19) & 0x7ffffff, parm);\
  OUT(op,i*64+24, (w10 >>  8) & 0x7ffffff, parm);\
  OUT(op,i*64+25, (w10 >> 35) & 0x7ffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*27+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w10 >> 62) | (w11 <<  2) & 0x7ffffff, parm);\
  OUT(op,i*64+27, (w11 >> 25) & 0x7ffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*27+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w11 >> 52) | (w12 << 12) & 0x7ffffff, parm);\
  OUT(op,i*64+29, (w12 >> 15) & 0x7ffffff, parm);   uint64_t w13 = *(uint32_t *)(ip+(i*27+13)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_28(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*7+0)*8/sizeof(ip[0]));\
  OUT(op,i*16+ 0, (w0 ) & 0xfffffff, parm);\
  OUT(op,i*16+ 1, (w0 >> 28) & 0xfffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*7+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 2, (w0 >> 56) | (w1 <<  8) & 0xfffffff, parm);\
  OUT(op,i*16+ 3, (w1 >> 20) & 0xfffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*7+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 4, (w1 >> 48) | (w2 << 16) & 0xfffffff, parm);\
  OUT(op,i*16+ 5, (w2 >> 12) & 0xfffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*7+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 6, (w2 >> 40) | (w3 << 24) & 0xfffffff, parm);\
  OUT(op,i*16+ 7, (w3 >>  4) & 0xfffffff, parm);\
  OUT(op,i*16+ 8, (w3 >> 32) & 0xfffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*7+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 9, (w3 >> 60) | (w4 <<  4) & 0xfffffff, parm);\
  OUT(op,i*16+10, (w4 >> 24) & 0xfffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*7+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+11, (w4 >> 52) | (w5 << 12) & 0xfffffff, parm);\
  OUT(op,i*16+12, (w5 >> 16) & 0xfffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*7+6)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_29(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*29+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1fffffff, parm);\
  OUT(op,i*64+ 1, (w0 >> 29) & 0x1fffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*29+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w0 >> 58) | (w1 <<  6) & 0x1fffffff, parm);\
  OUT(op,i*64+ 3, (w1 >> 23) & 0x1fffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*29+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w1 >> 52) | (w2 << 12) & 0x1fffffff, parm);\
  OUT(op,i*64+ 5, (w2 >> 17) & 0x1fffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*29+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w2 >> 46) | (w3 << 18) & 0x1fffffff, parm);\
  OUT(op,i*64+ 7, (w3 >> 11) & 0x1fffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*29+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w3 >> 40) | (w4 << 24) & 0x1fffffff, parm);\
  OUT(op,i*64+ 9, (w4 >>  5) & 0x1fffffff, parm);\
  OUT(op,i*64+10, (w4 >> 34) & 0x1fffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*29+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w4 >> 63) | (w5 <<  1) & 0x1fffffff, parm);\
  OUT(op,i*64+12, (w5 >> 28) & 0x1fffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*29+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w5 >> 57) | (w6 <<  7) & 0x1fffffff, parm);\
  OUT(op,i*64+14, (w6 >> 22) & 0x1fffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*29+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w6 >> 51) | (w7 << 13) & 0x1fffffff, parm);\
  OUT(op,i*64+16, (w7 >> 16) & 0x1fffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*29+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w7 >> 45) | (w8 << 19) & 0x1fffffff, parm);\
  OUT(op,i*64+18, (w8 >> 10) & 0x1fffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*29+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w8 >> 39) | (w9 << 25) & 0x1fffffff, parm);\
  OUT(op,i*64+20, (w9 >>  4) & 0x1fffffff, parm);\
  OUT(op,i*64+21, (w9 >> 33) & 0x1fffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*29+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w9 >> 62) | (w10 <<  2) & 0x1fffffff, parm);\
  OUT(op,i*64+23, (w10 >> 27) & 0x1fffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*29+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w10 >> 56) | (w11 <<  8) & 0x1fffffff, parm);\
  OUT(op,i*64+25, (w11 >> 21) & 0x1fffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*29+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w11 >> 50) | (w12 << 14) & 0x1fffffff, parm);\
  OUT(op,i*64+27, (w12 >> 15) & 0x1fffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*29+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w12 >> 44) | (w13 << 20) & 0x1fffffff, parm);\
  OUT(op,i*64+29, (w13 >>  9) & 0x1fffffff, parm);   uint64_t w14 = *(uint32_t *)(ip+(i*29+14)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_30(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*15+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3fffffff, parm);\
  OUT(op,i*32+ 1, (w0 >> 30) & 0x3fffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*15+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w0 >> 60) | (w1 <<  4) & 0x3fffffff, parm);\
  OUT(op,i*32+ 3, (w1 >> 26) & 0x3fffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*15+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 4, (w1 >> 56) | (w2 <<  8) & 0x3fffffff, parm);\
  OUT(op,i*32+ 5, (w2 >> 22) & 0x3fffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*15+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 6, (w2 >> 52) | (w3 << 12) & 0x3fffffff, parm);\
  OUT(op,i*32+ 7, (w3 >> 18) & 0x3fffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*15+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w3 >> 48) | (w4 << 16) & 0x3fffffff, parm);\
  OUT(op,i*32+ 9, (w4 >> 14) & 0x3fffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*15+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+10, (w4 >> 44) | (w5 << 20) & 0x3fffffff, parm);\
  OUT(op,i*32+11, (w5 >> 10) & 0x3fffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*15+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+12, (w5 >> 40) | (w6 << 24) & 0x3fffffff, parm);\
  OUT(op,i*32+13, (w6 >>  6) & 0x3fffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*15+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w6 >> 36) | (w7 << 28) & 0x3fffffff, parm);\
  OUT(op,i*32+15, (w7 >>  2) & 0x3fffffff, parm);\
  OUT(op,i*32+16, (w7 >> 32) & 0x3fffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*15+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w7 >> 62) | (w8 <<  2) & 0x3fffffff, parm);\
  OUT(op,i*32+18, (w8 >> 28) & 0x3fffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*15+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+19, (w8 >> 58) | (w9 <<  6) & 0x3fffffff, parm);\
  OUT(op,i*32+20, (w9 >> 24) & 0x3fffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*15+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+21, (w9 >> 54) | (w10 << 10) & 0x3fffffff, parm);\
  OUT(op,i*32+22, (w10 >> 20) & 0x3fffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*15+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w10 >> 50) | (w11 << 14) & 0x3fffffff, parm);\
  OUT(op,i*32+24, (w11 >> 16) & 0x3fffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*15+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+25, (w11 >> 46) | (w12 << 18) & 0x3fffffff, parm);\
  OUT(op,i*32+26, (w12 >> 12) & 0x3fffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*15+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+27, (w12 >> 42) | (w13 << 22) & 0x3fffffff, parm);\
  OUT(op,i*32+28, (w13 >>  8) & 0x3fffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*15+14)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_31(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*31+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7fffffff, parm);\
  OUT(op,i*64+ 1, (w0 >> 31) & 0x7fffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*31+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w0 >> 62) | (w1 <<  2) & 0x7fffffff, parm);\
  OUT(op,i*64+ 3, (w1 >> 29) & 0x7fffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*31+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w1 >> 60) | (w2 <<  4) & 0x7fffffff, parm);\
  OUT(op,i*64+ 5, (w2 >> 27) & 0x7fffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*31+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w2 >> 58) | (w3 <<  6) & 0x7fffffff, parm);\
  OUT(op,i*64+ 7, (w3 >> 25) & 0x7fffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*31+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w3 >> 56) | (w4 <<  8) & 0x7fffffff, parm);\
  OUT(op,i*64+ 9, (w4 >> 23) & 0x7fffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*31+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w4 >> 54) | (w5 << 10) & 0x7fffffff, parm);\
  OUT(op,i*64+11, (w5 >> 21) & 0x7fffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*31+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w5 >> 52) | (w6 << 12) & 0x7fffffff, parm);\
  OUT(op,i*64+13, (w6 >> 19) & 0x7fffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*31+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w6 >> 50) | (w7 << 14) & 0x7fffffff, parm);\
  OUT(op,i*64+15, (w7 >> 17) & 0x7fffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*31+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w7 >> 48) | (w8 << 16) & 0x7fffffff, parm);\
  OUT(op,i*64+17, (w8 >> 15) & 0x7fffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*31+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w8 >> 46) | (w9 << 18) & 0x7fffffff, parm);\
  OUT(op,i*64+19, (w9 >> 13) & 0x7fffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*31+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w9 >> 44) | (w10 << 20) & 0x7fffffff, parm);\
  OUT(op,i*64+21, (w10 >> 11) & 0x7fffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*31+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w10 >> 42) | (w11 << 22) & 0x7fffffff, parm);\
  OUT(op,i*64+23, (w11 >>  9) & 0x7fffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*31+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w11 >> 40) | (w12 << 24) & 0x7fffffff, parm);\
  OUT(op,i*64+25, (w12 >>  7) & 0x7fffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*31+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w12 >> 38) | (w13 << 26) & 0x7fffffff, parm);\
  OUT(op,i*64+27, (w13 >>  5) & 0x7fffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*31+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w13 >> 36) | (w14 << 28) & 0x7fffffff, parm);\
  OUT(op,i*64+29, (w14 >>  3) & 0x7fffffff, parm);   uint64_t w15 = *(uint32_t *)(ip+(i*31+15)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_33(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*33+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1ffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*33+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 33) | (w1 << 31) & 0x1ffffffff, parm);\
  OUT(op,i*64+ 2, (w1 >>  2) & 0x1ffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*33+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w1 >> 35) | (w2 << 29) & 0x1ffffffff, parm);\
  OUT(op,i*64+ 4, (w2 >>  4) & 0x1ffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*33+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w2 >> 37) | (w3 << 27) & 0x1ffffffff, parm);\
  OUT(op,i*64+ 6, (w3 >>  6) & 0x1ffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*33+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w3 >> 39) | (w4 << 25) & 0x1ffffffff, parm);\
  OUT(op,i*64+ 8, (w4 >>  8) & 0x1ffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*33+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w4 >> 41) | (w5 << 23) & 0x1ffffffff, parm);\
  OUT(op,i*64+10, (w5 >> 10) & 0x1ffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*33+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w5 >> 43) | (w6 << 21) & 0x1ffffffff, parm);\
  OUT(op,i*64+12, (w6 >> 12) & 0x1ffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*33+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w6 >> 45) | (w7 << 19) & 0x1ffffffff, parm);\
  OUT(op,i*64+14, (w7 >> 14) & 0x1ffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*33+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w7 >> 47) | (w8 << 17) & 0x1ffffffff, parm);\
  OUT(op,i*64+16, (w8 >> 16) & 0x1ffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*33+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w8 >> 49) | (w9 << 15) & 0x1ffffffff, parm);\
  OUT(op,i*64+18, (w9 >> 18) & 0x1ffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*33+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w9 >> 51) | (w10 << 13) & 0x1ffffffff, parm);\
  OUT(op,i*64+20, (w10 >> 20) & 0x1ffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*33+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w10 >> 53) | (w11 << 11) & 0x1ffffffff, parm);\
  OUT(op,i*64+22, (w11 >> 22) & 0x1ffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*33+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w11 >> 55) | (w12 <<  9) & 0x1ffffffff, parm);\
  OUT(op,i*64+24, (w12 >> 24) & 0x1ffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*33+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w12 >> 57) | (w13 <<  7) & 0x1ffffffff, parm);\
  OUT(op,i*64+26, (w13 >> 26) & 0x1ffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*33+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w13 >> 59) | (w14 <<  5) & 0x1ffffffff, parm);\
  OUT(op,i*64+28, (w14 >> 28) & 0x1ffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*33+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w14 >> 61) | (w15 <<  3) & 0x1ffffffff, parm);\
  OUT(op,i*64+30, (w15 >> 30) & 0x1ffffffff, parm);   uint64_t w16 = *(uint32_t *)(ip+(i*33+16)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_34(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*17+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3ffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*17+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 1, (w0 >> 34) | (w1 << 30) & 0x3ffffffff, parm);\
  OUT(op,i*32+ 2, (w1 >>  4) & 0x3ffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*17+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w1 >> 38) | (w2 << 26) & 0x3ffffffff, parm);\
  OUT(op,i*32+ 4, (w2 >>  8) & 0x3ffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*17+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w2 >> 42) | (w3 << 22) & 0x3ffffffff, parm);\
  OUT(op,i*32+ 6, (w3 >> 12) & 0x3ffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*17+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w3 >> 46) | (w4 << 18) & 0x3ffffffff, parm);\
  OUT(op,i*32+ 8, (w4 >> 16) & 0x3ffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*17+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w4 >> 50) | (w5 << 14) & 0x3ffffffff, parm);\
  OUT(op,i*32+10, (w5 >> 20) & 0x3ffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*17+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w5 >> 54) | (w6 << 10) & 0x3ffffffff, parm);\
  OUT(op,i*32+12, (w6 >> 24) & 0x3ffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*17+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+13, (w6 >> 58) | (w7 <<  6) & 0x3ffffffff, parm);\
  OUT(op,i*32+14, (w7 >> 28) & 0x3ffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*17+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w7 >> 62) | (w8 <<  2) & 0x3ffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*17+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w8 >> 32) | (w9 << 32) & 0x3ffffffff, parm);\
  OUT(op,i*32+17, (w9 >>  2) & 0x3ffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*17+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w9 >> 36) | (w10 << 28) & 0x3ffffffff, parm);\
  OUT(op,i*32+19, (w10 >>  6) & 0x3ffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*17+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w10 >> 40) | (w11 << 24) & 0x3ffffffff, parm);\
  OUT(op,i*32+21, (w11 >> 10) & 0x3ffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*17+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+22, (w11 >> 44) | (w12 << 20) & 0x3ffffffff, parm);\
  OUT(op,i*32+23, (w12 >> 14) & 0x3ffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*17+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w12 >> 48) | (w13 << 16) & 0x3ffffffff, parm);\
  OUT(op,i*32+25, (w13 >> 18) & 0x3ffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*17+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w13 >> 52) | (w14 << 12) & 0x3ffffffff, parm);\
  OUT(op,i*32+27, (w14 >> 22) & 0x3ffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*17+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+28, (w14 >> 56) | (w15 <<  8) & 0x3ffffffff, parm);\
  OUT(op,i*32+29, (w15 >> 26) & 0x3ffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*17+16)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_35(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*35+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7ffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*35+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 35) | (w1 << 29) & 0x7ffffffff, parm);\
  OUT(op,i*64+ 2, (w1 >>  6) & 0x7ffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*35+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w1 >> 41) | (w2 << 23) & 0x7ffffffff, parm);\
  OUT(op,i*64+ 4, (w2 >> 12) & 0x7ffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*35+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w2 >> 47) | (w3 << 17) & 0x7ffffffff, parm);\
  OUT(op,i*64+ 6, (w3 >> 18) & 0x7ffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*35+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w3 >> 53) | (w4 << 11) & 0x7ffffffff, parm);\
  OUT(op,i*64+ 8, (w4 >> 24) & 0x7ffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*35+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w4 >> 59) | (w5 <<  5) & 0x7ffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*35+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w5 >> 30) | (w6 << 34) & 0x7ffffffff, parm);\
  OUT(op,i*64+11, (w6 >>  1) & 0x7ffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*35+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w6 >> 36) | (w7 << 28) & 0x7ffffffff, parm);\
  OUT(op,i*64+13, (w7 >>  7) & 0x7ffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*35+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w7 >> 42) | (w8 << 22) & 0x7ffffffff, parm);\
  OUT(op,i*64+15, (w8 >> 13) & 0x7ffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*35+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w8 >> 48) | (w9 << 16) & 0x7ffffffff, parm);\
  OUT(op,i*64+17, (w9 >> 19) & 0x7ffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*35+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w9 >> 54) | (w10 << 10) & 0x7ffffffff, parm);\
  OUT(op,i*64+19, (w10 >> 25) & 0x7ffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*35+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w10 >> 60) | (w11 <<  4) & 0x7ffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*35+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w11 >> 31) | (w12 << 33) & 0x7ffffffff, parm);\
  OUT(op,i*64+22, (w12 >>  2) & 0x7ffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*35+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w12 >> 37) | (w13 << 27) & 0x7ffffffff, parm);\
  OUT(op,i*64+24, (w13 >>  8) & 0x7ffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*35+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w13 >> 43) | (w14 << 21) & 0x7ffffffff, parm);\
  OUT(op,i*64+26, (w14 >> 14) & 0x7ffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*35+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w14 >> 49) | (w15 << 15) & 0x7ffffffff, parm);\
  OUT(op,i*64+28, (w15 >> 20) & 0x7ffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*35+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w15 >> 55) | (w16 <<  9) & 0x7ffffffff, parm);\
  OUT(op,i*64+30, (w16 >> 26) & 0x7ffffffff, parm);   uint64_t w17 = *(uint32_t *)(ip+(i*35+17)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_36(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*9+0)*8/sizeof(ip[0]));\
  OUT(op,i*16+ 0, (w0 ) & 0xfffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*9+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 1, (w0 >> 36) | (w1 << 28) & 0xfffffffff, parm);\
  OUT(op,i*16+ 2, (w1 >>  8) & 0xfffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*9+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 3, (w1 >> 44) | (w2 << 20) & 0xfffffffff, parm);\
  OUT(op,i*16+ 4, (w2 >> 16) & 0xfffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*9+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 5, (w2 >> 52) | (w3 << 12) & 0xfffffffff, parm);\
  OUT(op,i*16+ 6, (w3 >> 24) & 0xfffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*9+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 7, (w3 >> 60) | (w4 <<  4) & 0xfffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*9+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 8, (w4 >> 32) | (w5 << 32) & 0xfffffffff, parm);\
  OUT(op,i*16+ 9, (w5 >>  4) & 0xfffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*9+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+10, (w5 >> 40) | (w6 << 24) & 0xfffffffff, parm);\
  OUT(op,i*16+11, (w6 >> 12) & 0xfffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*9+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+12, (w6 >> 48) | (w7 << 16) & 0xfffffffff, parm);\
  OUT(op,i*16+13, (w7 >> 20) & 0xfffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*9+8)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_37(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*37+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1fffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*37+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 37) | (w1 << 27) & 0x1fffffffff, parm);\
  OUT(op,i*64+ 2, (w1 >> 10) & 0x1fffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*37+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w1 >> 47) | (w2 << 17) & 0x1fffffffff, parm);\
  OUT(op,i*64+ 4, (w2 >> 20) & 0x1fffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*37+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w2 >> 57) | (w3 <<  7) & 0x1fffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*37+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w3 >> 30) | (w4 << 34) & 0x1fffffffff, parm);\
  OUT(op,i*64+ 7, (w4 >>  3) & 0x1fffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*37+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w4 >> 40) | (w5 << 24) & 0x1fffffffff, parm);\
  OUT(op,i*64+ 9, (w5 >> 13) & 0x1fffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*37+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w5 >> 50) | (w6 << 14) & 0x1fffffffff, parm);\
  OUT(op,i*64+11, (w6 >> 23) & 0x1fffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*37+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w6 >> 60) | (w7 <<  4) & 0x1fffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*37+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w7 >> 33) | (w8 << 31) & 0x1fffffffff, parm);\
  OUT(op,i*64+14, (w8 >>  6) & 0x1fffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*37+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w8 >> 43) | (w9 << 21) & 0x1fffffffff, parm);\
  OUT(op,i*64+16, (w9 >> 16) & 0x1fffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*37+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w9 >> 53) | (w10 << 11) & 0x1fffffffff, parm);\
  OUT(op,i*64+18, (w10 >> 26) & 0x1fffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*37+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w10 >> 63) | (w11 <<  1) & 0x1fffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*37+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w11 >> 36) | (w12 << 28) & 0x1fffffffff, parm);\
  OUT(op,i*64+21, (w12 >>  9) & 0x1fffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*37+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w12 >> 46) | (w13 << 18) & 0x1fffffffff, parm);\
  OUT(op,i*64+23, (w13 >> 19) & 0x1fffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*37+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w13 >> 56) | (w14 <<  8) & 0x1fffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*37+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w14 >> 29) | (w15 << 35) & 0x1fffffffff, parm);\
  OUT(op,i*64+26, (w15 >>  2) & 0x1fffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*37+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w15 >> 39) | (w16 << 25) & 0x1fffffffff, parm);\
  OUT(op,i*64+28, (w16 >> 12) & 0x1fffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*37+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w16 >> 49) | (w17 << 15) & 0x1fffffffff, parm);\
  OUT(op,i*64+30, (w17 >> 22) & 0x1fffffffff, parm);   uint64_t w18 = *(uint32_t *)(ip+(i*37+18)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_38(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*19+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3fffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*19+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 1, (w0 >> 38) | (w1 << 26) & 0x3fffffffff, parm);\
  OUT(op,i*32+ 2, (w1 >> 12) & 0x3fffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*19+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w1 >> 50) | (w2 << 14) & 0x3fffffffff, parm);\
  OUT(op,i*32+ 4, (w2 >> 24) & 0x3fffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*19+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w2 >> 62) | (w3 <<  2) & 0x3fffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*19+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 6, (w3 >> 36) | (w4 << 28) & 0x3fffffffff, parm);\
  OUT(op,i*32+ 7, (w4 >> 10) & 0x3fffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*19+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w4 >> 48) | (w5 << 16) & 0x3fffffffff, parm);\
  OUT(op,i*32+ 9, (w5 >> 22) & 0x3fffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*19+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+10, (w5 >> 60) | (w6 <<  4) & 0x3fffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*19+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w6 >> 34) | (w7 << 30) & 0x3fffffffff, parm);\
  OUT(op,i*32+12, (w7 >>  8) & 0x3fffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*19+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+13, (w7 >> 46) | (w8 << 18) & 0x3fffffffff, parm);\
  OUT(op,i*32+14, (w8 >> 20) & 0x3fffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*19+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w8 >> 58) | (w9 <<  6) & 0x3fffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*19+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w9 >> 32) | (w10 << 32) & 0x3fffffffff, parm);\
  OUT(op,i*32+17, (w10 >>  6) & 0x3fffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*19+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w10 >> 44) | (w11 << 20) & 0x3fffffffff, parm);\
  OUT(op,i*32+19, (w11 >> 18) & 0x3fffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*19+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w11 >> 56) | (w12 <<  8) & 0x3fffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*19+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+21, (w12 >> 30) | (w13 << 34) & 0x3fffffffff, parm);\
  OUT(op,i*32+22, (w13 >>  4) & 0x3fffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*19+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w13 >> 42) | (w14 << 22) & 0x3fffffffff, parm);\
  OUT(op,i*32+24, (w14 >> 16) & 0x3fffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*19+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+25, (w14 >> 54) | (w15 << 10) & 0x3fffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*19+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w15 >> 28) | (w16 << 36) & 0x3fffffffff, parm);\
  OUT(op,i*32+27, (w16 >>  2) & 0x3fffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*19+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+28, (w16 >> 40) | (w17 << 24) & 0x3fffffffff, parm);\
  OUT(op,i*32+29, (w17 >> 14) & 0x3fffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*19+18)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_39(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*39+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7fffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*39+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 39) | (w1 << 25) & 0x7fffffffff, parm);\
  OUT(op,i*64+ 2, (w1 >> 14) & 0x7fffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*39+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w1 >> 53) | (w2 << 11) & 0x7fffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*39+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w2 >> 28) | (w3 << 36) & 0x7fffffffff, parm);\
  OUT(op,i*64+ 5, (w3 >>  3) & 0x7fffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*39+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w3 >> 42) | (w4 << 22) & 0x7fffffffff, parm);\
  OUT(op,i*64+ 7, (w4 >> 17) & 0x7fffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*39+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w4 >> 56) | (w5 <<  8) & 0x7fffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*39+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w5 >> 31) | (w6 << 33) & 0x7fffffffff, parm);\
  OUT(op,i*64+10, (w6 >>  6) & 0x7fffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*39+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w6 >> 45) | (w7 << 19) & 0x7fffffffff, parm);\
  OUT(op,i*64+12, (w7 >> 20) & 0x7fffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*39+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w7 >> 59) | (w8 <<  5) & 0x7fffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*39+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w8 >> 34) | (w9 << 30) & 0x7fffffffff, parm);\
  OUT(op,i*64+15, (w9 >>  9) & 0x7fffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*39+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w9 >> 48) | (w10 << 16) & 0x7fffffffff, parm);\
  OUT(op,i*64+17, (w10 >> 23) & 0x7fffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*39+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w10 >> 62) | (w11 <<  2) & 0x7fffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*39+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w11 >> 37) | (w12 << 27) & 0x7fffffffff, parm);\
  OUT(op,i*64+20, (w12 >> 12) & 0x7fffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*39+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w12 >> 51) | (w13 << 13) & 0x7fffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*39+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w13 >> 26) | (w14 << 38) & 0x7fffffffff, parm);\
  OUT(op,i*64+23, (w14 >>  1) & 0x7fffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*39+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w14 >> 40) | (w15 << 24) & 0x7fffffffff, parm);\
  OUT(op,i*64+25, (w15 >> 15) & 0x7fffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*39+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w15 >> 54) | (w16 << 10) & 0x7fffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*39+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w16 >> 29) | (w17 << 35) & 0x7fffffffff, parm);\
  OUT(op,i*64+28, (w17 >>  4) & 0x7fffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*39+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w17 >> 43) | (w18 << 21) & 0x7fffffffff, parm);\
  OUT(op,i*64+30, (w18 >> 18) & 0x7fffffffff, parm);   uint64_t w19 = *(uint32_t *)(ip+(i*39+19)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_40(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*5+0)*8/sizeof(ip[0]));\
  OUT(op,i*8+ 0, (w0 ) & 0xffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*5+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 1, (w0 >> 40) | (w1 << 24) & 0xffffffffff, parm);\
  OUT(op,i*8+ 2, (w1 >> 16) & 0xffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*5+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 3, (w1 >> 56) | (w2 <<  8) & 0xffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*5+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 4, (w2 >> 32) | (w3 << 32) & 0xffffffffff, parm);\
  OUT(op,i*8+ 5, (w3 >>  8) & 0xffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*5+4)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_41(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*41+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1ffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*41+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 41) | (w1 << 23) & 0x1ffffffffff, parm);\
  OUT(op,i*64+ 2, (w1 >> 18) & 0x1ffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*41+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w1 >> 59) | (w2 <<  5) & 0x1ffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*41+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w2 >> 36) | (w3 << 28) & 0x1ffffffffff, parm);\
  OUT(op,i*64+ 5, (w3 >> 13) & 0x1ffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*41+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w3 >> 54) | (w4 << 10) & 0x1ffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*41+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w4 >> 31) | (w5 << 33) & 0x1ffffffffff, parm);\
  OUT(op,i*64+ 8, (w5 >>  8) & 0x1ffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*41+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w5 >> 49) | (w6 << 15) & 0x1ffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*41+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w6 >> 26) | (w7 << 38) & 0x1ffffffffff, parm);\
  OUT(op,i*64+11, (w7 >>  3) & 0x1ffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*41+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w7 >> 44) | (w8 << 20) & 0x1ffffffffff, parm);\
  OUT(op,i*64+13, (w8 >> 21) & 0x1ffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*41+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w8 >> 62) | (w9 <<  2) & 0x1ffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*41+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w9 >> 39) | (w10 << 25) & 0x1ffffffffff, parm);\
  OUT(op,i*64+16, (w10 >> 16) & 0x1ffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*41+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w10 >> 57) | (w11 <<  7) & 0x1ffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*41+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w11 >> 34) | (w12 << 30) & 0x1ffffffffff, parm);\
  OUT(op,i*64+19, (w12 >> 11) & 0x1ffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*41+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w12 >> 52) | (w13 << 12) & 0x1ffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*41+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w13 >> 29) | (w14 << 35) & 0x1ffffffffff, parm);\
  OUT(op,i*64+22, (w14 >>  6) & 0x1ffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*41+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w14 >> 47) | (w15 << 17) & 0x1ffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*41+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w15 >> 24) | (w16 << 40) & 0x1ffffffffff, parm);\
  OUT(op,i*64+25, (w16 >>  1) & 0x1ffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*41+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w16 >> 42) | (w17 << 22) & 0x1ffffffffff, parm);\
  OUT(op,i*64+27, (w17 >> 19) & 0x1ffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*41+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w17 >> 60) | (w18 <<  4) & 0x1ffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*41+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w18 >> 37) | (w19 << 27) & 0x1ffffffffff, parm);\
  OUT(op,i*64+30, (w19 >> 14) & 0x1ffffffffff, parm);   uint64_t w20 = *(uint32_t *)(ip+(i*41+20)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_42(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*21+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3ffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*21+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 1, (w0 >> 42) | (w1 << 22) & 0x3ffffffffff, parm);\
  OUT(op,i*32+ 2, (w1 >> 20) & 0x3ffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*21+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w1 >> 62) | (w2 <<  2) & 0x3ffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*21+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 4, (w2 >> 40) | (w3 << 24) & 0x3ffffffffff, parm);\
  OUT(op,i*32+ 5, (w3 >> 18) & 0x3ffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*21+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 6, (w3 >> 60) | (w4 <<  4) & 0x3ffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*21+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w4 >> 38) | (w5 << 26) & 0x3ffffffffff, parm);\
  OUT(op,i*32+ 8, (w5 >> 16) & 0x3ffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*21+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w5 >> 58) | (w6 <<  6) & 0x3ffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*21+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+10, (w6 >> 36) | (w7 << 28) & 0x3ffffffffff, parm);\
  OUT(op,i*32+11, (w7 >> 14) & 0x3ffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*21+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+12, (w7 >> 56) | (w8 <<  8) & 0x3ffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*21+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+13, (w8 >> 34) | (w9 << 30) & 0x3ffffffffff, parm);\
  OUT(op,i*32+14, (w9 >> 12) & 0x3ffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*21+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w9 >> 54) | (w10 << 10) & 0x3ffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*21+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w10 >> 32) | (w11 << 32) & 0x3ffffffffff, parm);\
  OUT(op,i*32+17, (w11 >> 10) & 0x3ffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*21+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w11 >> 52) | (w12 << 12) & 0x3ffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*21+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+19, (w12 >> 30) | (w13 << 34) & 0x3ffffffffff, parm);\
  OUT(op,i*32+20, (w13 >>  8) & 0x3ffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*21+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+21, (w13 >> 50) | (w14 << 14) & 0x3ffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*21+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+22, (w14 >> 28) | (w15 << 36) & 0x3ffffffffff, parm);\
  OUT(op,i*32+23, (w15 >>  6) & 0x3ffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*21+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w15 >> 48) | (w16 << 16) & 0x3ffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*21+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+25, (w16 >> 26) | (w17 << 38) & 0x3ffffffffff, parm);\
  OUT(op,i*32+26, (w17 >>  4) & 0x3ffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*21+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+27, (w17 >> 46) | (w18 << 18) & 0x3ffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*21+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+28, (w18 >> 24) | (w19 << 40) & 0x3ffffffffff, parm);\
  OUT(op,i*32+29, (w19 >>  2) & 0x3ffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*21+20)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_43(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*43+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7ffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*43+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 43) | (w1 << 21) & 0x7ffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*43+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 22) | (w2 << 42) & 0x7ffffffffff, parm);\
  OUT(op,i*64+ 3, (w2 >>  1) & 0x7ffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*43+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w2 >> 44) | (w3 << 20) & 0x7ffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*43+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w3 >> 23) | (w4 << 41) & 0x7ffffffffff, parm);\
  OUT(op,i*64+ 6, (w4 >>  2) & 0x7ffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*43+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w4 >> 45) | (w5 << 19) & 0x7ffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*43+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w5 >> 24) | (w6 << 40) & 0x7ffffffffff, parm);\
  OUT(op,i*64+ 9, (w6 >>  3) & 0x7ffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*43+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w6 >> 46) | (w7 << 18) & 0x7ffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*43+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w7 >> 25) | (w8 << 39) & 0x7ffffffffff, parm);\
  OUT(op,i*64+12, (w8 >>  4) & 0x7ffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*43+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w8 >> 47) | (w9 << 17) & 0x7ffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*43+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w9 >> 26) | (w10 << 38) & 0x7ffffffffff, parm);\
  OUT(op,i*64+15, (w10 >>  5) & 0x7ffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*43+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w10 >> 48) | (w11 << 16) & 0x7ffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*43+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w11 >> 27) | (w12 << 37) & 0x7ffffffffff, parm);\
  OUT(op,i*64+18, (w12 >>  6) & 0x7ffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*43+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w12 >> 49) | (w13 << 15) & 0x7ffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*43+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w13 >> 28) | (w14 << 36) & 0x7ffffffffff, parm);\
  OUT(op,i*64+21, (w14 >>  7) & 0x7ffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*43+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w14 >> 50) | (w15 << 14) & 0x7ffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*43+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w15 >> 29) | (w16 << 35) & 0x7ffffffffff, parm);\
  OUT(op,i*64+24, (w16 >>  8) & 0x7ffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*43+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w16 >> 51) | (w17 << 13) & 0x7ffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*43+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w17 >> 30) | (w18 << 34) & 0x7ffffffffff, parm);\
  OUT(op,i*64+27, (w18 >>  9) & 0x7ffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*43+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w18 >> 52) | (w19 << 12) & 0x7ffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*43+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w19 >> 31) | (w20 << 33) & 0x7ffffffffff, parm);\
  OUT(op,i*64+30, (w20 >> 10) & 0x7ffffffffff, parm);   uint64_t w21 = *(uint32_t *)(ip+(i*43+21)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_44(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*11+0)*8/sizeof(ip[0]));\
  OUT(op,i*16+ 0, (w0 ) & 0xfffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*11+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 1, (w0 >> 44) | (w1 << 20) & 0xfffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*11+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 2, (w1 >> 24) | (w2 << 40) & 0xfffffffffff, parm);\
  OUT(op,i*16+ 3, (w2 >>  4) & 0xfffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*11+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 4, (w2 >> 48) | (w3 << 16) & 0xfffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*11+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 5, (w3 >> 28) | (w4 << 36) & 0xfffffffffff, parm);\
  OUT(op,i*16+ 6, (w4 >>  8) & 0xfffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*11+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 7, (w4 >> 52) | (w5 << 12) & 0xfffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*11+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 8, (w5 >> 32) | (w6 << 32) & 0xfffffffffff, parm);\
  OUT(op,i*16+ 9, (w6 >> 12) & 0xfffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*11+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+10, (w6 >> 56) | (w7 <<  8) & 0xfffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*11+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+11, (w7 >> 36) | (w8 << 28) & 0xfffffffffff, parm);\
  OUT(op,i*16+12, (w8 >> 16) & 0xfffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*11+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+13, (w8 >> 60) | (w9 <<  4) & 0xfffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*11+10)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_45(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*45+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1fffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*45+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 45) | (w1 << 19) & 0x1fffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*45+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 26) | (w2 << 38) & 0x1fffffffffff, parm);\
  OUT(op,i*64+ 3, (w2 >>  7) & 0x1fffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*45+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w2 >> 52) | (w3 << 12) & 0x1fffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*45+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w3 >> 33) | (w4 << 31) & 0x1fffffffffff, parm);\
  OUT(op,i*64+ 6, (w4 >> 14) & 0x1fffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*45+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w4 >> 59) | (w5 <<  5) & 0x1fffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*45+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w5 >> 40) | (w6 << 24) & 0x1fffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*45+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w6 >> 21) | (w7 << 43) & 0x1fffffffffff, parm);\
  OUT(op,i*64+10, (w7 >>  2) & 0x1fffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*45+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w7 >> 47) | (w8 << 17) & 0x1fffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*45+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w8 >> 28) | (w9 << 36) & 0x1fffffffffff, parm);\
  OUT(op,i*64+13, (w9 >>  9) & 0x1fffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*45+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w9 >> 54) | (w10 << 10) & 0x1fffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*45+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w10 >> 35) | (w11 << 29) & 0x1fffffffffff, parm);\
  OUT(op,i*64+16, (w11 >> 16) & 0x1fffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*45+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w11 >> 61) | (w12 <<  3) & 0x1fffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*45+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w12 >> 42) | (w13 << 22) & 0x1fffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*45+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w13 >> 23) | (w14 << 41) & 0x1fffffffffff, parm);\
  OUT(op,i*64+20, (w14 >>  4) & 0x1fffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*45+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w14 >> 49) | (w15 << 15) & 0x1fffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*45+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w15 >> 30) | (w16 << 34) & 0x1fffffffffff, parm);\
  OUT(op,i*64+23, (w16 >> 11) & 0x1fffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*45+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w16 >> 56) | (w17 <<  8) & 0x1fffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*45+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w17 >> 37) | (w18 << 27) & 0x1fffffffffff, parm);\
  OUT(op,i*64+26, (w18 >> 18) & 0x1fffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*45+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w18 >> 63) | (w19 <<  1) & 0x1fffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*45+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w19 >> 44) | (w20 << 20) & 0x1fffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*45+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w20 >> 25) | (w21 << 39) & 0x1fffffffffff, parm);\
  OUT(op,i*64+30, (w21 >>  6) & 0x1fffffffffff, parm);   uint64_t w22 = *(uint32_t *)(ip+(i*45+22)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_46(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*23+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3fffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*23+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 1, (w0 >> 46) | (w1 << 18) & 0x3fffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*23+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w1 >> 28) | (w2 << 36) & 0x3fffffffffff, parm);\
  OUT(op,i*32+ 3, (w2 >> 10) & 0x3fffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*23+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 4, (w2 >> 56) | (w3 <<  8) & 0x3fffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*23+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w3 >> 38) | (w4 << 26) & 0x3fffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*23+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 6, (w4 >> 20) | (w5 << 44) & 0x3fffffffffff, parm);\
  OUT(op,i*32+ 7, (w5 >>  2) & 0x3fffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*23+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w5 >> 48) | (w6 << 16) & 0x3fffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*23+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w6 >> 30) | (w7 << 34) & 0x3fffffffffff, parm);\
  OUT(op,i*32+10, (w7 >> 12) & 0x3fffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*23+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w7 >> 58) | (w8 <<  6) & 0x3fffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*23+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+12, (w8 >> 40) | (w9 << 24) & 0x3fffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*23+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+13, (w9 >> 22) | (w10 << 42) & 0x3fffffffffff, parm);\
  OUT(op,i*32+14, (w10 >>  4) & 0x3fffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*23+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w10 >> 50) | (w11 << 14) & 0x3fffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*23+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w11 >> 32) | (w12 << 32) & 0x3fffffffffff, parm);\
  OUT(op,i*32+17, (w12 >> 14) & 0x3fffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*23+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w12 >> 60) | (w13 <<  4) & 0x3fffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*23+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+19, (w13 >> 42) | (w14 << 22) & 0x3fffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*23+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w14 >> 24) | (w15 << 40) & 0x3fffffffffff, parm);\
  OUT(op,i*32+21, (w15 >>  6) & 0x3fffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*23+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+22, (w15 >> 52) | (w16 << 12) & 0x3fffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*23+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w16 >> 34) | (w17 << 30) & 0x3fffffffffff, parm);\
  OUT(op,i*32+24, (w17 >> 16) & 0x3fffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*23+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+25, (w17 >> 62) | (w18 <<  2) & 0x3fffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*23+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w18 >> 44) | (w19 << 20) & 0x3fffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*23+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+27, (w19 >> 26) | (w20 << 38) & 0x3fffffffffff, parm);\
  OUT(op,i*32+28, (w20 >>  8) & 0x3fffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*23+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+29, (w20 >> 54) | (w21 << 10) & 0x3fffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*23+22)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_47(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*47+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7fffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*47+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 47) | (w1 << 17) & 0x7fffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*47+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 30) | (w2 << 34) & 0x7fffffffffff, parm);\
  OUT(op,i*64+ 3, (w2 >> 13) & 0x7fffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*47+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w2 >> 60) | (w3 <<  4) & 0x7fffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*47+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w3 >> 43) | (w4 << 21) & 0x7fffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*47+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w4 >> 26) | (w5 << 38) & 0x7fffffffffff, parm);\
  OUT(op,i*64+ 7, (w5 >>  9) & 0x7fffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*47+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w5 >> 56) | (w6 <<  8) & 0x7fffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*47+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w6 >> 39) | (w7 << 25) & 0x7fffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*47+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w7 >> 22) | (w8 << 42) & 0x7fffffffffff, parm);\
  OUT(op,i*64+11, (w8 >>  5) & 0x7fffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*47+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w8 >> 52) | (w9 << 12) & 0x7fffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*47+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w9 >> 35) | (w10 << 29) & 0x7fffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*47+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w10 >> 18) | (w11 << 46) & 0x7fffffffffff, parm);\
  OUT(op,i*64+15, (w11 >>  1) & 0x7fffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*47+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w11 >> 48) | (w12 << 16) & 0x7fffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*47+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w12 >> 31) | (w13 << 33) & 0x7fffffffffff, parm);\
  OUT(op,i*64+18, (w13 >> 14) & 0x7fffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*47+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w13 >> 61) | (w14 <<  3) & 0x7fffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*47+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w14 >> 44) | (w15 << 20) & 0x7fffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*47+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w15 >> 27) | (w16 << 37) & 0x7fffffffffff, parm);\
  OUT(op,i*64+22, (w16 >> 10) & 0x7fffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*47+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w16 >> 57) | (w17 <<  7) & 0x7fffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*47+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w17 >> 40) | (w18 << 24) & 0x7fffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*47+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w18 >> 23) | (w19 << 41) & 0x7fffffffffff, parm);\
  OUT(op,i*64+26, (w19 >>  6) & 0x7fffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*47+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w19 >> 53) | (w20 << 11) & 0x7fffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*47+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w20 >> 36) | (w21 << 28) & 0x7fffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*47+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w21 >> 19) | (w22 << 45) & 0x7fffffffffff, parm);\
  OUT(op,i*64+30, (w22 >>  2) & 0x7fffffffffff, parm);   uint64_t w23 = *(uint32_t *)(ip+(i*47+23)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_48(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*3+0)*8/sizeof(ip[0]));\
  OUT(op,i*4+ 0, (w0 ) & 0xffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*3+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*4+ 1, (w0 >> 48) | (w1 << 16) & 0xffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*3+2)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_49(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*49+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1ffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*49+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 49) | (w1 << 15) & 0x1ffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*49+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 34) | (w2 << 30) & 0x1ffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*49+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w2 >> 19) | (w3 << 45) & 0x1ffffffffffff, parm);\
  OUT(op,i*64+ 4, (w3 >>  4) & 0x1ffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*49+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w3 >> 53) | (w4 << 11) & 0x1ffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*49+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w4 >> 38) | (w5 << 26) & 0x1ffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*49+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w5 >> 23) | (w6 << 41) & 0x1ffffffffffff, parm);\
  OUT(op,i*64+ 8, (w6 >>  8) & 0x1ffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*49+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w6 >> 57) | (w7 <<  7) & 0x1ffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*49+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w7 >> 42) | (w8 << 22) & 0x1ffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*49+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w8 >> 27) | (w9 << 37) & 0x1ffffffffffff, parm);\
  OUT(op,i*64+12, (w9 >> 12) & 0x1ffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*49+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w9 >> 61) | (w10 <<  3) & 0x1ffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*49+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w10 >> 46) | (w11 << 18) & 0x1ffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*49+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w11 >> 31) | (w12 << 33) & 0x1ffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*49+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w12 >> 16) | (w13 << 48) & 0x1ffffffffffff, parm);\
  OUT(op,i*64+17, (w13 >>  1) & 0x1ffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*49+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w13 >> 50) | (w14 << 14) & 0x1ffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*49+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w14 >> 35) | (w15 << 29) & 0x1ffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*49+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w15 >> 20) | (w16 << 44) & 0x1ffffffffffff, parm);\
  OUT(op,i*64+21, (w16 >>  5) & 0x1ffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*49+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w16 >> 54) | (w17 << 10) & 0x1ffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*49+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w17 >> 39) | (w18 << 25) & 0x1ffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*49+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w18 >> 24) | (w19 << 40) & 0x1ffffffffffff, parm);\
  OUT(op,i*64+25, (w19 >>  9) & 0x1ffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*49+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w19 >> 58) | (w20 <<  6) & 0x1ffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*49+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w20 >> 43) | (w21 << 21) & 0x1ffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*49+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w21 >> 28) | (w22 << 36) & 0x1ffffffffffff, parm);\
  OUT(op,i*64+29, (w22 >> 13) & 0x1ffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*49+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+30, (w22 >> 62) | (w23 <<  2) & 0x1ffffffffffff, parm);   uint64_t w24 = *(uint32_t *)(ip+(i*49+24)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_50(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*25+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3ffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*25+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 1, (w0 >> 50) | (w1 << 14) & 0x3ffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*25+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w1 >> 36) | (w2 << 28) & 0x3ffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*25+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w2 >> 22) | (w3 << 42) & 0x3ffffffffffff, parm);\
  OUT(op,i*32+ 4, (w3 >>  8) & 0x3ffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*25+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w3 >> 58) | (w4 <<  6) & 0x3ffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*25+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 6, (w4 >> 44) | (w5 << 20) & 0x3ffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*25+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w5 >> 30) | (w6 << 34) & 0x3ffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*25+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w6 >> 16) | (w7 << 48) & 0x3ffffffffffff, parm);\
  OUT(op,i*32+ 9, (w7 >>  2) & 0x3ffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*25+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+10, (w7 >> 52) | (w8 << 12) & 0x3ffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*25+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w8 >> 38) | (w9 << 26) & 0x3ffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*25+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+12, (w9 >> 24) | (w10 << 40) & 0x3ffffffffffff, parm);\
  OUT(op,i*32+13, (w10 >> 10) & 0x3ffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*25+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w10 >> 60) | (w11 <<  4) & 0x3ffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*25+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w11 >> 46) | (w12 << 18) & 0x3ffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*25+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w12 >> 32) | (w13 << 32) & 0x3ffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*25+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w13 >> 18) | (w14 << 46) & 0x3ffffffffffff, parm);\
  OUT(op,i*32+18, (w14 >>  4) & 0x3ffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*25+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+19, (w14 >> 54) | (w15 << 10) & 0x3ffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*25+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w15 >> 40) | (w16 << 24) & 0x3ffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*25+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+21, (w16 >> 26) | (w17 << 38) & 0x3ffffffffffff, parm);\
  OUT(op,i*32+22, (w17 >> 12) & 0x3ffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*25+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w17 >> 62) | (w18 <<  2) & 0x3ffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*25+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w18 >> 48) | (w19 << 16) & 0x3ffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*25+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+25, (w19 >> 34) | (w20 << 30) & 0x3ffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*25+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w20 >> 20) | (w21 << 44) & 0x3ffffffffffff, parm);\
  OUT(op,i*32+27, (w21 >>  6) & 0x3ffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*25+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+28, (w21 >> 56) | (w22 <<  8) & 0x3ffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*25+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+29, (w22 >> 42) | (w23 << 22) & 0x3ffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*25+24)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_51(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*51+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7ffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*51+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 51) | (w1 << 13) & 0x7ffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*51+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 38) | (w2 << 26) & 0x7ffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*51+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w2 >> 25) | (w3 << 39) & 0x7ffffffffffff, parm);\
  OUT(op,i*64+ 4, (w3 >> 12) & 0x7ffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*51+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w3 >> 63) | (w4 <<  1) & 0x7ffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*51+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w4 >> 50) | (w5 << 14) & 0x7ffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*51+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w5 >> 37) | (w6 << 27) & 0x7ffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*51+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w6 >> 24) | (w7 << 40) & 0x7ffffffffffff, parm);\
  OUT(op,i*64+ 9, (w7 >> 11) & 0x7ffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*51+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w7 >> 62) | (w8 <<  2) & 0x7ffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*51+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w8 >> 49) | (w9 << 15) & 0x7ffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*51+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w9 >> 36) | (w10 << 28) & 0x7ffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*51+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w10 >> 23) | (w11 << 41) & 0x7ffffffffffff, parm);\
  OUT(op,i*64+14, (w11 >> 10) & 0x7ffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*51+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w11 >> 61) | (w12 <<  3) & 0x7ffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*51+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w12 >> 48) | (w13 << 16) & 0x7ffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*51+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w13 >> 35) | (w14 << 29) & 0x7ffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*51+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w14 >> 22) | (w15 << 42) & 0x7ffffffffffff, parm);\
  OUT(op,i*64+19, (w15 >>  9) & 0x7ffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*51+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w15 >> 60) | (w16 <<  4) & 0x7ffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*51+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w16 >> 47) | (w17 << 17) & 0x7ffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*51+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w17 >> 34) | (w18 << 30) & 0x7ffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*51+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w18 >> 21) | (w19 << 43) & 0x7ffffffffffff, parm);\
  OUT(op,i*64+24, (w19 >>  8) & 0x7ffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*51+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w19 >> 59) | (w20 <<  5) & 0x7ffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*51+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w20 >> 46) | (w21 << 18) & 0x7ffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*51+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w21 >> 33) | (w22 << 31) & 0x7ffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*51+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w22 >> 20) | (w23 << 44) & 0x7ffffffffffff, parm);\
  OUT(op,i*64+29, (w23 >>  7) & 0x7ffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*51+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+30, (w23 >> 58) | (w24 <<  6) & 0x7ffffffffffff, parm);   uint64_t w25 = *(uint32_t *)(ip+(i*51+25)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_52(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*13+0)*8/sizeof(ip[0]));\
  OUT(op,i*16+ 0, (w0 ) & 0xfffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*13+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 1, (w0 >> 52) | (w1 << 12) & 0xfffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*13+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 2, (w1 >> 40) | (w2 << 24) & 0xfffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*13+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 3, (w2 >> 28) | (w3 << 36) & 0xfffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*13+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 4, (w3 >> 16) | (w4 << 48) & 0xfffffffffffff, parm);\
  OUT(op,i*16+ 5, (w4 >>  4) & 0xfffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*13+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 6, (w4 >> 56) | (w5 <<  8) & 0xfffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*13+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 7, (w5 >> 44) | (w6 << 20) & 0xfffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*13+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 8, (w6 >> 32) | (w7 << 32) & 0xfffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*13+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 9, (w7 >> 20) | (w8 << 44) & 0xfffffffffffff, parm);\
  OUT(op,i*16+10, (w8 >>  8) & 0xfffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*13+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+11, (w8 >> 60) | (w9 <<  4) & 0xfffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*13+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+12, (w9 >> 48) | (w10 << 16) & 0xfffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*13+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+13, (w10 >> 36) | (w11 << 28) & 0xfffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*13+12)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_53(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*53+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1fffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*53+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 53) | (w1 << 11) & 0x1fffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*53+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 42) | (w2 << 22) & 0x1fffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*53+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w2 >> 31) | (w3 << 33) & 0x1fffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*53+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w3 >> 20) | (w4 << 44) & 0x1fffffffffffff, parm);\
  OUT(op,i*64+ 5, (w4 >>  9) & 0x1fffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*53+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w4 >> 62) | (w5 <<  2) & 0x1fffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*53+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w5 >> 51) | (w6 << 13) & 0x1fffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*53+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w6 >> 40) | (w7 << 24) & 0x1fffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*53+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w7 >> 29) | (w8 << 35) & 0x1fffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*53+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w8 >> 18) | (w9 << 46) & 0x1fffffffffffff, parm);\
  OUT(op,i*64+11, (w9 >>  7) & 0x1fffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*53+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w9 >> 60) | (w10 <<  4) & 0x1fffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*53+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w10 >> 49) | (w11 << 15) & 0x1fffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*53+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w11 >> 38) | (w12 << 26) & 0x1fffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*53+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w12 >> 27) | (w13 << 37) & 0x1fffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*53+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w13 >> 16) | (w14 << 48) & 0x1fffffffffffff, parm);\
  OUT(op,i*64+17, (w14 >>  5) & 0x1fffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*53+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w14 >> 58) | (w15 <<  6) & 0x1fffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*53+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w15 >> 47) | (w16 << 17) & 0x1fffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*53+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w16 >> 36) | (w17 << 28) & 0x1fffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*53+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w17 >> 25) | (w18 << 39) & 0x1fffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*53+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w18 >> 14) | (w19 << 50) & 0x1fffffffffffff, parm);\
  OUT(op,i*64+23, (w19 >>  3) & 0x1fffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*53+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w19 >> 56) | (w20 <<  8) & 0x1fffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*53+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w20 >> 45) | (w21 << 19) & 0x1fffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*53+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w21 >> 34) | (w22 << 30) & 0x1fffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*53+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w22 >> 23) | (w23 << 41) & 0x1fffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*53+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w23 >> 12) | (w24 << 52) & 0x1fffffffffffff, parm);\
  OUT(op,i*64+29, (w24 >>  1) & 0x1fffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*53+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+30, (w24 >> 54) | (w25 << 10) & 0x1fffffffffffff, parm);   uint64_t w26 = *(uint32_t *)(ip+(i*53+26)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_54(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*27+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3fffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*27+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 1, (w0 >> 54) | (w1 << 10) & 0x3fffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*27+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w1 >> 44) | (w2 << 20) & 0x3fffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*27+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w2 >> 34) | (w3 << 30) & 0x3fffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*27+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 4, (w3 >> 24) | (w4 << 40) & 0x3fffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*27+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w4 >> 14) | (w5 << 50) & 0x3fffffffffffff, parm);\
  OUT(op,i*32+ 6, (w5 >>  4) & 0x3fffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*27+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w5 >> 58) | (w6 <<  6) & 0x3fffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*27+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w6 >> 48) | (w7 << 16) & 0x3fffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*27+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w7 >> 38) | (w8 << 26) & 0x3fffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*27+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+10, (w8 >> 28) | (w9 << 36) & 0x3fffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*27+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w9 >> 18) | (w10 << 46) & 0x3fffffffffffff, parm);\
  OUT(op,i*32+12, (w10 >>  8) & 0x3fffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*27+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+13, (w10 >> 62) | (w11 <<  2) & 0x3fffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*27+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w11 >> 52) | (w12 << 12) & 0x3fffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*27+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w12 >> 42) | (w13 << 22) & 0x3fffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*27+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w13 >> 32) | (w14 << 32) & 0x3fffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*27+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w14 >> 22) | (w15 << 42) & 0x3fffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*27+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w15 >> 12) | (w16 << 52) & 0x3fffffffffffff, parm);\
  OUT(op,i*32+19, (w16 >>  2) & 0x3fffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*27+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w16 >> 56) | (w17 <<  8) & 0x3fffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*27+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+21, (w17 >> 46) | (w18 << 18) & 0x3fffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*27+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+22, (w18 >> 36) | (w19 << 28) & 0x3fffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*27+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w19 >> 26) | (w20 << 38) & 0x3fffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*27+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w20 >> 16) | (w21 << 48) & 0x3fffffffffffff, parm);\
  OUT(op,i*32+25, (w21 >>  6) & 0x3fffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*27+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w21 >> 60) | (w22 <<  4) & 0x3fffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*27+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+27, (w22 >> 50) | (w23 << 14) & 0x3fffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*27+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+28, (w23 >> 40) | (w24 << 24) & 0x3fffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*27+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+29, (w24 >> 30) | (w25 << 34) & 0x3fffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*27+26)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_55(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*55+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7fffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*55+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 55) | (w1 <<  9) & 0x7fffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*55+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 46) | (w2 << 18) & 0x7fffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*55+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w2 >> 37) | (w3 << 27) & 0x7fffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*55+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w3 >> 28) | (w4 << 36) & 0x7fffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*55+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w4 >> 19) | (w5 << 45) & 0x7fffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*55+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w5 >> 10) | (w6 << 54) & 0x7fffffffffffff, parm);\
  OUT(op,i*64+ 7, (w6 >>  1) & 0x7fffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*55+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w6 >> 56) | (w7 <<  8) & 0x7fffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*55+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w7 >> 47) | (w8 << 17) & 0x7fffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*55+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w8 >> 38) | (w9 << 26) & 0x7fffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*55+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w9 >> 29) | (w10 << 35) & 0x7fffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*55+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w10 >> 20) | (w11 << 44) & 0x7fffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*55+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w11 >> 11) | (w12 << 53) & 0x7fffffffffffff, parm);\
  OUT(op,i*64+14, (w12 >>  2) & 0x7fffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*55+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w12 >> 57) | (w13 <<  7) & 0x7fffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*55+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w13 >> 48) | (w14 << 16) & 0x7fffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*55+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w14 >> 39) | (w15 << 25) & 0x7fffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*55+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w15 >> 30) | (w16 << 34) & 0x7fffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*55+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w16 >> 21) | (w17 << 43) & 0x7fffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*55+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w17 >> 12) | (w18 << 52) & 0x7fffffffffffff, parm);\
  OUT(op,i*64+21, (w18 >>  3) & 0x7fffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*55+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w18 >> 58) | (w19 <<  6) & 0x7fffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*55+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w19 >> 49) | (w20 << 15) & 0x7fffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*55+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w20 >> 40) | (w21 << 24) & 0x7fffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*55+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w21 >> 31) | (w22 << 33) & 0x7fffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*55+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w22 >> 22) | (w23 << 42) & 0x7fffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*55+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w23 >> 13) | (w24 << 51) & 0x7fffffffffffff, parm);\
  OUT(op,i*64+28, (w24 >>  4) & 0x7fffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*55+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w24 >> 59) | (w25 <<  5) & 0x7fffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*55+26)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+30, (w25 >> 50) | (w26 << 14) & 0x7fffffffffffff, parm);   uint64_t w27 = *(uint32_t *)(ip+(i*55+27)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_56(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*7+0)*8/sizeof(ip[0]));\
  OUT(op,i*8+ 0, (w0 ) & 0xffffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*7+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 1, (w0 >> 56) | (w1 <<  8) & 0xffffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*7+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 2, (w1 >> 48) | (w2 << 16) & 0xffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*7+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 3, (w2 >> 40) | (w3 << 24) & 0xffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*7+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 4, (w3 >> 32) | (w4 << 32) & 0xffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*7+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*8+ 5, (w4 >> 24) | (w5 << 40) & 0xffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*7+6)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_57(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*57+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x1ffffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*57+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 57) | (w1 <<  7) & 0x1ffffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*57+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 50) | (w2 << 14) & 0x1ffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*57+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w2 >> 43) | (w3 << 21) & 0x1ffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*57+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w3 >> 36) | (w4 << 28) & 0x1ffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*57+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w4 >> 29) | (w5 << 35) & 0x1ffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*57+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w5 >> 22) | (w6 << 42) & 0x1ffffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*57+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w6 >> 15) | (w7 << 49) & 0x1ffffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*57+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w7 >> 8) | (w8 << 56) & 0x1ffffffffffffff, parm);\
  OUT(op,i*64+ 9, (w8 >>  1) & 0x1ffffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*57+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w8 >> 58) | (w9 <<  6) & 0x1ffffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*57+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w9 >> 51) | (w10 << 13) & 0x1ffffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*57+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w10 >> 44) | (w11 << 20) & 0x1ffffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*57+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w11 >> 37) | (w12 << 27) & 0x1ffffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*57+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w12 >> 30) | (w13 << 34) & 0x1ffffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*57+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w13 >> 23) | (w14 << 41) & 0x1ffffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*57+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w14 >> 16) | (w15 << 48) & 0x1ffffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*57+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w15 >> 9) | (w16 << 55) & 0x1ffffffffffffff, parm);\
  OUT(op,i*64+18, (w16 >>  2) & 0x1ffffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*57+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w16 >> 59) | (w17 <<  5) & 0x1ffffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*57+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w17 >> 52) | (w18 << 12) & 0x1ffffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*57+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w18 >> 45) | (w19 << 19) & 0x1ffffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*57+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w19 >> 38) | (w20 << 26) & 0x1ffffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*57+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w20 >> 31) | (w21 << 33) & 0x1ffffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*57+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w21 >> 24) | (w22 << 40) & 0x1ffffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*57+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w22 >> 17) | (w23 << 47) & 0x1ffffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*57+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w23 >> 10) | (w24 << 54) & 0x1ffffffffffffff, parm);\
  OUT(op,i*64+27, (w24 >>  3) & 0x1ffffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*57+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w24 >> 60) | (w25 <<  4) & 0x1ffffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*57+26)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w25 >> 53) | (w26 << 11) & 0x1ffffffffffffff, parm);   uint64_t w27 = *(uint64_t *)(ip+(i*57+27)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+30, (w26 >> 46) | (w27 << 18) & 0x1ffffffffffffff, parm);   uint64_t w28 = *(uint32_t *)(ip+(i*57+28)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_58(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*29+0)*8/sizeof(ip[0]));\
  OUT(op,i*32+ 0, (w0 ) & 0x3ffffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*29+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 1, (w0 >> 58) | (w1 <<  6) & 0x3ffffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*29+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w1 >> 52) | (w2 << 12) & 0x3ffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*29+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w2 >> 46) | (w3 << 18) & 0x3ffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*29+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 4, (w3 >> 40) | (w4 << 24) & 0x3ffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*29+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w4 >> 34) | (w5 << 30) & 0x3ffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*29+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 6, (w5 >> 28) | (w6 << 36) & 0x3ffffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*29+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w6 >> 22) | (w7 << 42) & 0x3ffffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*29+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w7 >> 16) | (w8 << 48) & 0x3ffffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*29+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w8 >> 10) | (w9 << 54) & 0x3ffffffffffffff, parm);\
  OUT(op,i*32+10, (w9 >>  4) & 0x3ffffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*29+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w9 >> 62) | (w10 <<  2) & 0x3ffffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*29+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+12, (w10 >> 56) | (w11 <<  8) & 0x3ffffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*29+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+13, (w11 >> 50) | (w12 << 14) & 0x3ffffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*29+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w12 >> 44) | (w13 << 20) & 0x3ffffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*29+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w13 >> 38) | (w14 << 26) & 0x3ffffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*29+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w14 >> 32) | (w15 << 32) & 0x3ffffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*29+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w15 >> 26) | (w16 << 38) & 0x3ffffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*29+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w16 >> 20) | (w17 << 44) & 0x3ffffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*29+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+19, (w17 >> 14) | (w18 << 50) & 0x3ffffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*29+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w18 >> 8) | (w19 << 56) & 0x3ffffffffffffff, parm);\
  OUT(op,i*32+21, (w19 >>  2) & 0x3ffffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*29+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+22, (w19 >> 60) | (w20 <<  4) & 0x3ffffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*29+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w20 >> 54) | (w21 << 10) & 0x3ffffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*29+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w21 >> 48) | (w22 << 16) & 0x3ffffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*29+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+25, (w22 >> 42) | (w23 << 22) & 0x3ffffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*29+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w23 >> 36) | (w24 << 28) & 0x3ffffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*29+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+27, (w24 >> 30) | (w25 << 34) & 0x3ffffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*29+26)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+28, (w25 >> 24) | (w26 << 40) & 0x3ffffffffffffff, parm);   uint64_t w27 = *(uint64_t *)(ip+(i*29+27)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+29, (w26 >> 18) | (w27 << 46) & 0x3ffffffffffffff, parm);   uint64_t w28 = *(uint64_t *)(ip+(i*29+28)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_59(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*59+0)*8/sizeof(ip[0]));\
  OUT(op,i*64+ 0, (w0 ) & 0x7ffffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*59+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 1, (w0 >> 59) | (w1 <<  5) & 0x7ffffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*59+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w1 >> 54) | (w2 << 10) & 0x7ffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*59+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w2 >> 49) | (w3 << 15) & 0x7ffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*59+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w3 >> 44) | (w4 << 20) & 0x7ffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*59+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w4 >> 39) | (w5 << 25) & 0x7ffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*59+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w5 >> 34) | (w6 << 30) & 0x7ffffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*59+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w6 >> 29) | (w7 << 35) & 0x7ffffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*59+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w7 >> 24) | (w8 << 40) & 0x7ffffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*59+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w8 >> 19) | (w9 << 45) & 0x7ffffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*59+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w9 >> 14) | (w10 << 50) & 0x7ffffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*59+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w10 >> 9) | (w11 << 55) & 0x7ffffffffffffff, parm);\
  OUT(op,i*64+12, (w11 >>  4) & 0x7ffffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*59+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w11 >> 63) | (w12 <<  1) & 0x7ffffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*59+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w12 >> 58) | (w13 <<  6) & 0x7ffffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*59+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w13 >> 53) | (w14 << 11) & 0x7ffffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*59+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w14 >> 48) | (w15 << 16) & 0x7ffffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*59+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w15 >> 43) | (w16 << 21) & 0x7ffffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*59+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w16 >> 38) | (w17 << 26) & 0x7ffffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*59+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w17 >> 33) | (w18 << 31) & 0x7ffffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*59+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w18 >> 28) | (w19 << 36) & 0x7ffffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*59+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w19 >> 23) | (w20 << 41) & 0x7ffffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*59+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w20 >> 18) | (w21 << 46) & 0x7ffffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*59+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w21 >> 13) | (w22 << 51) & 0x7ffffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*59+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w22 >> 8) | (w23 << 56) & 0x7ffffffffffffff, parm);\
  OUT(op,i*64+25, (w23 >>  3) & 0x7ffffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*59+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w23 >> 62) | (w24 <<  2) & 0x7ffffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*59+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w24 >> 57) | (w25 <<  7) & 0x7ffffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*59+26)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w25 >> 52) | (w26 << 12) & 0x7ffffffffffffff, parm);   uint64_t w27 = *(uint64_t *)(ip+(i*59+27)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w26 >> 47) | (w27 << 17) & 0x7ffffffffffffff, parm);   uint64_t w28 = *(uint64_t *)(ip+(i*59+28)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+30, (w27 >> 42) | (w28 << 22) & 0x7ffffffffffffff, parm);   uint64_t w29 = *(uint32_t *)(ip+(i*59+29)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_60(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*15+0)*8/sizeof(ip[0]));\
  OUT(op,i*16+ 0, (w0 ) & 0xfffffffffffffff, parm);   uint64_t w1 = *(uint64_t *)(ip+(i*15+1)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 1, (w0 >> 60) | (w1 <<  4) & 0xfffffffffffffff, parm);   uint64_t w2 = *(uint64_t *)(ip+(i*15+2)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 2, (w1 >> 56) | (w2 <<  8) & 0xfffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*15+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 3, (w2 >> 52) | (w3 << 12) & 0xfffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*15+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 4, (w3 >> 48) | (w4 << 16) & 0xfffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*15+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 5, (w4 >> 44) | (w5 << 20) & 0xfffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*15+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 6, (w5 >> 40) | (w6 << 24) & 0xfffffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*15+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 7, (w6 >> 36) | (w7 << 28) & 0xfffffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*15+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 8, (w7 >> 32) | (w8 << 32) & 0xfffffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*15+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+ 9, (w8 >> 28) | (w9 << 36) & 0xfffffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*15+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+10, (w9 >> 24) | (w10 << 40) & 0xfffffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*15+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+11, (w10 >> 20) | (w11 << 44) & 0xfffffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*15+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+12, (w11 >> 16) | (w12 << 48) & 0xfffffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*15+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*16+13, (w12 >> 12) | (w13 << 52) & 0xfffffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*15+14)*8/sizeof(ip[0]));\
\
...
\
  OUT(op,i*64+ 1, (w1 >> 64) | (w2 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*61+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w2 >> 64) | (w3 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*61+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w3 >> 64) | (w4 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*61+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w4 >> 64) | (w5 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*61+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w5 >> 64) | (w6 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*61+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w6 >> 64) | (w7 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*61+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w7 >> 64) | (w8 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*61+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w8 >> 64) | (w9 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*61+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w9 >> 64) | (w10 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*61+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w10 >> 64) | (w11 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*61+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w11 >> 64) | (w12 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*61+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w12 >> 64) | (w13 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*61+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w13 >> 64) | (w14 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*61+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w14 >> 64) | (w15 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*61+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w15 >> 64) | (w16 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*61+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w16 >> 64) | (w17 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*61+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w17 >> 64) | (w18 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*61+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w18 >> 64) | (w19 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*61+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w19 >> 64) | (w20 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*61+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w20 >> 64) | (w21 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*61+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w21 >> 64) | (w22 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*61+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w22 >> 64) | (w23 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*61+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w23 >> 64) | (w24 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*61+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w24 >> 64) | (w25 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*61+26)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w25 >> 64) | (w26 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w27 = *(uint64_t *)(ip+(i*61+27)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w26 >> 64) | (w27 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w28 = *(uint64_t *)(ip+(i*61+28)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w27 >> 64) | (w28 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w29 = *(uint64_t *)(ip+(i*61+29)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w28 >> 64) | (w29 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w30 = *(uint64_t *)(ip+(i*61+30)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w29 >> 64) | (w30 <<  0) & 0x1fffffffffffffff, parm);   uint64_t w31 = *(uint64_t *)(ip+(i*61+31)*8/sizeof(ip[0]));\
\
...
\
  OUT(op,i*32+ 1, (w1 >> 64) | (w2 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*31+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 2, (w2 >> 64) | (w3 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*31+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 3, (w3 >> 64) | (w4 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*31+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 4, (w4 >> 64) | (w5 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*31+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 5, (w5 >> 64) | (w6 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*31+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 6, (w6 >> 64) | (w7 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*31+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 7, (w7 >> 64) | (w8 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*31+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 8, (w8 >> 64) | (w9 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*31+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+ 9, (w9 >> 64) | (w10 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*31+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+10, (w10 >> 64) | (w11 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*31+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+11, (w11 >> 64) | (w12 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*31+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+12, (w12 >> 64) | (w13 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*31+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+13, (w13 >> 64) | (w14 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*31+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+14, (w14 >> 64) | (w15 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*31+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+15, (w15 >> 64) | (w16 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*31+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+16, (w16 >> 64) | (w17 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*31+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+17, (w17 >> 64) | (w18 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*31+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+18, (w18 >> 64) | (w19 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*31+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+19, (w19 >> 64) | (w20 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*31+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+20, (w20 >> 64) | (w21 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*31+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+21, (w21 >> 64) | (w22 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*31+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+22, (w22 >> 64) | (w23 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*31+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+23, (w23 >> 64) | (w24 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*31+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+24, (w24 >> 64) | (w25 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*31+26)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+25, (w25 >> 64) | (w26 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w27 = *(uint64_t *)(ip+(i*31+27)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+26, (w26 >> 64) | (w27 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w28 = *(uint64_t *)(ip+(i*31+28)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+27, (w27 >> 64) | (w28 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w29 = *(uint64_t *)(ip+(i*31+29)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+28, (w28 >> 64) | (w29 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w30 = *(uint64_t *)(ip+(i*31+30)*8/sizeof(ip[0]));\
\
  OUT(op,i*32+29, (w29 >> 64) | (w30 <<  0) & 0x3fffffffffffffff, parm);   uint64_t w31 = *(uint64_t *)(ip+(i*31+31)*8/sizeof(ip[0]));\
\
...
\
  OUT(op,i*64+ 1, (w1 >> 64) | (w2 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w3 = *(uint64_t *)(ip+(i*63+3)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 2, (w2 >> 64) | (w3 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w4 = *(uint64_t *)(ip+(i*63+4)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 3, (w3 >> 64) | (w4 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w5 = *(uint64_t *)(ip+(i*63+5)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 4, (w4 >> 64) | (w5 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w6 = *(uint64_t *)(ip+(i*63+6)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 5, (w5 >> 64) | (w6 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w7 = *(uint64_t *)(ip+(i*63+7)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 6, (w6 >> 64) | (w7 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w8 = *(uint64_t *)(ip+(i*63+8)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 7, (w7 >> 64) | (w8 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w9 = *(uint64_t *)(ip+(i*63+9)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 8, (w8 >> 64) | (w9 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w10 = *(uint64_t *)(ip+(i*63+10)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+ 9, (w9 >> 64) | (w10 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w11 = *(uint64_t *)(ip+(i*63+11)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+10, (w10 >> 64) | (w11 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w12 = *(uint64_t *)(ip+(i*63+12)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+11, (w11 >> 64) | (w12 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w13 = *(uint64_t *)(ip+(i*63+13)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+12, (w12 >> 64) | (w13 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w14 = *(uint64_t *)(ip+(i*63+14)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+13, (w13 >> 64) | (w14 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w15 = *(uint64_t *)(ip+(i*63+15)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+14, (w14 >> 64) | (w15 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w16 = *(uint64_t *)(ip+(i*63+16)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+15, (w15 >> 64) | (w16 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w17 = *(uint64_t *)(ip+(i*63+17)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+16, (w16 >> 64) | (w17 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w18 = *(uint64_t *)(ip+(i*63+18)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+17, (w17 >> 64) | (w18 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w19 = *(uint64_t *)(ip+(i*63+19)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+18, (w18 >> 64) | (w19 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w20 = *(uint64_t *)(ip+(i*63+20)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+19, (w19 >> 64) | (w20 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w21 = *(uint64_t *)(ip+(i*63+21)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+20, (w20 >> 64) | (w21 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w22 = *(uint64_t *)(ip+(i*63+22)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+21, (w21 >> 64) | (w22 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w23 = *(uint64_t *)(ip+(i*63+23)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+22, (w22 >> 64) | (w23 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w24 = *(uint64_t *)(ip+(i*63+24)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+23, (w23 >> 64) | (w24 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w25 = *(uint64_t *)(ip+(i*63+25)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+24, (w24 >> 64) | (w25 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w26 = *(uint64_t *)(ip+(i*63+26)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+25, (w25 >> 64) | (w26 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w27 = *(uint64_t *)(ip+(i*63+27)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+26, (w26 >> 64) | (w27 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w28 = *(uint64_t *)(ip+(i*63+28)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+27, (w27 >> 64) | (w28 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w29 = *(uint64_t *)(ip+(i*63+29)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+28, (w28 >> 64) | (w29 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w30 = *(uint64_t *)(ip+(i*63+30)*8/sizeof(ip[0]));\
\
  OUT(op,i*64+29, (w29 >> 64) | (w30 <<  0) & 0x7fffffffffffffff, parm);   uint64_t w31 = *(uint64_t *)(ip+(i*63+31)*8/sizeof(ip[0]));\
\
...
#define BITUNBLK64_64(ip, i, op, parm) {    uint64_t w0 = *(uint64_t *)(ip+(i*1+0)*8/sizeof(ip[0]));\
...
ALIGNED(BITUNPACK_F8, TEMPLATE2(_BITUNPACK_,a8)[], 16) = {
...
ALIGNED(BITUNPACK_F16, TEMPLATE2(_BITUNPACK_,a16)[], 16) = {
...
ALIGNED(BITUNPACK_F32, TEMPLATE2(_BITUNPACK_,a32)[], 16) = {
...
ALIGNED(BITUNPACK_F64, TEMPLATE2(_BITUNPACK_,a64)[], 16) = {
...
ALIGNED(BITUNPACK_D8, TEMPLATE2(_BITUNPACK_,a8)[], 16) = {
  &TEMPLATE2(_BITUNPACK_,8_0),
  &TEMPLATE2(_BITUNPACK_,8_1),
  &TEMPLATE2(_BITUNPACK_,8_2),
  &TEMPLATE2(_BITUNPACK_,8_3),
...
ALIGNED(BITUNPACK_D16, TEMPLATE2(_BITUNPACK_,a16)[], 16) = {
  &TEMPLATE2(_BITUNPACK_,16_0),
  &TEMPLATE2(_BITUNPACK_,16_1),
  &TEMPLATE2(_BITUNPACK_,16_2),
  &TEMPLATE2(_BITUNPACK_,16_3),
...
ALIGNED(BITUNPACK_D32, TEMPLATE2(_BITUNPACK_,a32)[], 16) = {
  &TEMPLATE2(_BITUNPACK_,32_0),
  &TEMPLATE2(_BITUNPACK_,32_1),
  &TEMPLATE2(_BITUNPACK_,32_2),
  &TEMPLATE2(_BITUNPACK_,32_3),
...
ALIGNED(BITUNPACK_D64, TEMPLATE2(_BITUNPACK_,a64)[], 16) = {
  &TEMPLATE2(_BITUNPACK_,64_0),
  &TEMPLATE2(_BITUNPACK_,64_1),
  &TEMPLATE2(_BITUNPACK_,64_2),
  &TEMPLATE2(_BITUNPACK_,64_3),
