...
#define TPENC tpenc
#define TPDEC tpdec
#define TPZENC tpzenc
#define TPZDEC tpzdec
#define TPXENC tpxenc
#define TPXDEC tpxdec
...
#if !defined(__AVX2__) && !defined(__SSE3__) //include only 1 time
...
#if !defined(__AVX2__) && !defined(__SSE3__) && !defined(ISDELTA) //--------------------------------------- plain -------------------------------------------------------------------
...
// TODO: zigzag
void T2(TPZENC, ESIZE)(unsigned char *in, unsigned n, unsigned char *out) {
  unsigned char *op,*ip,*e;
  unsigned stride = n/STRIDE;
...
void T2(TPZDEC, ESIZE)(unsigned char *in, unsigned n, unsigned char *out) {
  unsigned char *op,*ip,*e;
  unsigned      stride = n/STRIDE;
...
// TODO: xor
void T2(TPXENC, ESIZE)(unsigned char *in, unsigned n, unsigned char *out) {
  unsigned char *op,*ip,*e;
  unsigned stride = n/STRIDE;
...
void T2(TPXDEC, ESIZE)(unsigned char *in, unsigned n, unsigned char *out) {
  unsigned char *op,*ip,*e;
  unsigned      stride = n/STRIDE;
