...
#ifdef USE_MACROS //---------------------------- _mm_set_epi/_mm_set1_epi ----------------------------------------------------------
...
#define _mm_set1_epi8(  _u8_ )      			(uint32x4_t)vdupq_n_u8( _u8_ )
#define _mm_set1_epi16( _u16_)     				(uint32x4_t)vdupq_n_u16(_u16_)
#define _mm_set1_epi32( _u32_)   				            vdupq_n_u32(_u32_)
#define _mm_set1_epi64x(_u64_)     				(uint32x4_t)vdupq_n_u64(_u64_)
...
//---------------------------------------------- arithmetic ops ------------------------------------------------------------------
#define _mm_add_epi16(  _a_,_b_)   				(uint32x4_t)vaddq_u16((uint16x8_t)(_a_), (uint16x8_t)(_b_)) 
#define _mm_add_epi32(  _a_,_b_)   				            vaddq_u32(             _a_,               _b_ ) 
#define _mm_sub_epi16(  _a_,_b_)   				(uint32x4_t)vsubq_u16((uint16x8_t)(_a_), (uint16x8_t)(_b_)) 
#define _mm_sub_epi32(  _a_,_b_)   				(uint32x4_t)vsubq_u32((uint32x4_t)(_a_), (uint32x4_t)(_b_)) 
#define _mm_mullo_epi32(_a_,_b_)   				(uint32x4_t)vmulq_s32(( int32x4_t)(_a_), ( int32x4_t)(_b_))
#define  mm_mullo_epu32(_a_,_b_)   				            vmulq_u32(_a_,_b_)
#define _mm_mul_epu32(  _a_,_b_)     			(uint32x4_t)vmull_u32(vget_low_u32(_a_),vget_low_u32(_b_))
//---------------------------------------------- logical ops ----------------------------------------------------------------------
#define _mm_or_si128(   _a_,_b_)    			(uint32x4_t)vorrq_u32(  (uint32x4_t)(_a_), (uint32x4_t)(_b_))
#define _mm_and_si128(  _a_,_b_)    			(uint32x4_t)vandq_u32(  (uint32x4_t)(_a_), (uint32x4_t)(_b_))
#define _mm_xor_si128(  _a_,_b_)    			(uint32x4_t)veorq_u32(  (uint32x4_t)(_a_), (uint32x4_t)(_b_))
//---------------------------------------------- shift / align --------------------------------------------------------------------
#define _mm_slli_epi16( _a_,_m_)    			(uint32x4_t)vshlq_n_u16((uint16x8_t)(_a_), _m_)
#define _mm_slli_epi32( _a_,_m_)    			(uint32x4_t)vshlq_n_u32((uint32x4_t)(_a_), _m_)
#define _mm_slli_si128( _a_,_m_)                (uint32x4_t)vextq_u8(vdupq_n_u8(0), (uint8x16_t)(_a_), 16 - (_m_) ) // _m_: 1 - 15
 
#define _mm_srli_epi16( _a_,_m_)    			(uint32x4_t)vshrq_n_u16((uint16x8_t)(_a_), _m_)
#define _mm_srli_epi32( _a_,_m_)    			(uint32x4_t)vshrq_n_u32((uint32x4_t)(_a_), _m_)
#define _mm_srli_epi64( _a_,_m_)    			(uint32x4_t)vshlq_n_u64((uint64x2_t)(_a_), _m_) 
#define _mm_srli_si128( _a_,_m_) 			    (uint32x4_t)vextq_s8((int8x16_t)(_a_), vdupq_n_s8(0), (_m_))

#define _mm_srai_epi16( _a_,_m_)			    (uint32x4_t)vshrq_n_s16((int16x8_t)(_a_), _m_)  
#define _mm_srai_epi32( _a_,_m_)			    (uint32x4_t)vshrq_n_s32((int32x4_t)(_a_), _m_) 											
#define _mm_alignr_epi8(_a_,_b_,_m_)            (uint32x4_t)vextq_u8(  (uint8x16_t)(_b_), (uint8x16_t)(_a_), _m_)                   
//---------------------------------------------- compare --------- true/false->1/0 (all bits set) ------------------------------
#define _mm_cmpeq_epi8( _a_,_b_)   				(uint32x4_t)vceqq_s8( ( int8x16_t)(_a_), ( int8x16_t)(_b_))
#define _mm_cmpeq_epi16(_a_,_b_)   				(uint32x4_t)vceqq_s16(( int16x8_t)(_a_), ( int16x8_t)(_b_))
#define _mm_cmpeq_epi32(_a_,_b_)   				(uint32x4_t)vceqq_s32(( int32x4_t)(_a_), ( int32x4_t)(_b_))

#define _mm_cmpgt_epi16(_a_,_b_)   				(uint32x4_t)vcgtq_s16(( int16x8_t)(_a_), ( int16x8_t)(_b_)) 
#define _mm_cmpgt_epi32(_a_,_b_)   				(uint32x4_t)vcgtq_s32(( int32x4_t)(_a_), ( int32x4_t)(_b_))

#define _mm_cmpgt_epu16(_a_,_b_)   				(uint32x4_t)vcgtq_u16((uint16x8_t)(_a_), (uint16x8_t)(_b_)) 
#define  mm_cmpgt_epu32(_a_,_b_)   				(uint32x4_t)vcgtq_u32(             _a_,               _b_) 
//---------------------------------------------- load/store ------------------------------------------------------------------
#define _mm_storel_epi64(_ip_,_a_)   			vst1q_lane_u64((uint64_t *)(_ip_), (uint64x2_t)(_a_), 0)
#define _mm_storeu_si128(_ip_,_a_)  			vst1q_u32(_ip_,_a_)

#define _mm_loadl_epi64(   _u64p_)              (uint32x4_t)vcombine_s32(vld1_s32((int32_t const *)(_u64p_)), vcreate_s32(0))
#define  mm_loadu_epi64p(  _u64p_,_a_) 			(uint32x4_t)vld1q_lane_u64((uint64_t *)(_u64p_), (uint64x2_t)(_a_), 0)
#define  mm_cvtsi64_si128p(_u64p_,_a_)          mm_loadu_epi64p(_u64p_,_a_)
#define _mm_cvtsi64_si128(_a_) 				    (uint32x4_t)vdupq_n_u64(_a_)  //vld1q_s64(_a_)
...
#define _mm_cvtsi32_si128(_a_) 					(uint32x4_t)vsetq_lane_s32(_a_, vdupq_n_s32(0), 0)
...
#define _mm_shuffle_epi8(_a_, _b_) 				(uint32x4_t)vqtbl1q_u8((uint8x16_t)(_a_), (uint8x16_t)(_b_))
    #if defined(__aarch64__)
#define  mm_shuffle_nnnn_epi32(_a_,_m_)     	(uint32x4_t)vdupq_laneq_u32(_a_, _m_)
    #else
#define  mm_shuffle_nnnn_epi32(_a_,_m_)         (uint32x4_t)vdupq_n_u32(vgetq_lane_u32(_a_, _m_)
    #endif
...
#define _mm_shuffle_epi32s(_a_, _m_) 			_mm_set_epi32(vgetq_lane_u32(_a_, ((_m_)     ) & 0x3),\
  ...
  #else
static ALWAYS_INLINE uint32x4_t	mm_shuffle_2031_epi32(uint32x4_t a) { uint32x4_t   v = (uint32x4_t)vrev64q_u32(a); uint32x2x2_t z = vtrn_u32(vget_low_u32(v), vget_high_u32(v)); return vcombine_u32(z.val[0], z.val[1]);}
static ALWAYS_INLINE uint32x4_t	mm_shuffle_3120_epi32(uint32x4_t a) {                                              uint32x2x2_t z = vtrn_u32(vget_low_u32(a), vget_high_u32(a)); return vcombine_u32(z.val[0], z.val[1]);}

static ALWAYS_INLINE uint32x4_t	_mm_shuffle_epi32(uint32x4_t _a_, const unsigned _m_) { const uint32x4_t _av =_a_;
                                                uint32x4_t _v =    vmovq_n_u32(vgetq_lane_u32(_av, (_m_)        & 0x3));
	                                                       _v = vsetq_lane_u32(vgetq_lane_u32(_av, ((_m_) >> 2) & 0x3), _v, 1);
	                                                       _v = vsetq_lane_u32(vgetq_lane_u32(_av, ((_m_) >> 4) & 0x3), _v, 2);
...
static ALWAYS_INLINE uint32x4_t	_mm_shuffle_epi32s(uint32x4_t _a_, const unsigned _m_) { 
...
#else
static ALWAYS_INLINE uint32x4_t	_mm_unpacklo_epi8( uint32x4_t _a_,uint32x4_t _b_) { uint8x8x2_t  _zv = vzip_u8 ( vget_low_u8( (uint8x16_t)(_a_)), vget_low_u8 ((uint8x16_t)(_b_)));  return (uint32x4_t)vcombine_u8( _zv.val[0], _zv.val[1]);}
static ALWAYS_INLINE uint32x4_t	_mm_unpacklo_epi16(uint32x4_t _a_,uint32x4_t _b_) { uint16x4x2_t _zv = vzip_u16( vget_low_u16((uint16x8_t)(_a_)), vget_low_u16((uint16x8_t)(_b_)));  return (uint32x4_t)vcombine_u16(_zv.val[0], _zv.val[1]);}
static ALWAYS_INLINE uint32x4_t	_mm_unpacklo_epi32(uint32x4_t _a_,uint32x4_t _b_) { uint32x2x2_t _zv = vzip_u32( vget_low_u32(             _a_ ), vget_low_u32(             _b_ ));  return             vcombine_u32(_zv.val[0], _zv.val[1]);}
static ALWAYS_INLINE uint32x4_t	_mm_unpacklo_epi64(uint32x4_t _a_,uint32x4_t _b_) {                                                                                                  return (uint32x4_t)vcombine_u64(vget_low_u64((uint64x2_t)(_a_)), vget_low_u64((uint64x2_t)(_b_))); }

static ALWAYS_INLINE uint32x4_t	_mm_unpackhi_epi8( uint32x4_t _a_,uint32x4_t _b_) { uint8x8x2_t  _zv = vzip_u8 (vget_high_u8( (uint8x16_t)(_a_)), vget_high_u8( (uint8x16_t)(_b_))); return (uint32x4_t)vcombine_u8( _zv.val[0], _zv.val[1]); }
static ALWAYS_INLINE uint32x4_t	_mm_unpackhi_epi16(uint32x4_t _a_,uint32x4_t _b_) { uint16x4x2_t _zv = vzip_u16(vget_high_u16((uint16x8_t)(_a_)), vget_high_u16((uint16x8_t)(_b_))); return (uint32x4_t)vcombine_u16(_zv.val[0], _zv.val[1]); }
static ALWAYS_INLINE uint32x4_t	_mm_unpackhi_epi32(uint32x4_t _a_,uint32x4_t _b_) { uint32x2x2_t _zv = vzip_u32(vget_high_u32(             _a_ ), vget_high_u32(             _b_ )); return             vcombine_u32(_zv.val[0], _zv.val[1]); }
static ALWAYS_INLINE uint32x4_t	_mm_unpackhi_epi64(uint32x4_t _a_,uint32x4_t _b_) {                                                                                                  return (uint32x4_t)vcombine_u64(vget_high_u64((uint64x2_t)(_a_)), vget_high_u64((uint64x2_t)(_b_))); }
#endif

#define _mm_packs_epi16(   _a_,_b_) 		    (uint32x4_t)vcombine_s8( vqmovn_s16((int16x8_t)(_a_)), vqmovn_s16((int16x8_t)(_b_)))
#define _mm_packs_epi32(   _a_,_b_) 		    (uint32x4_t)vcombine_s16(vqmovn_s32((int32x4_t)(_a_)), vqmovn_s32((int32x4_t)(_b_)))

#define _mm_packs_epu16(   _a_,_b_) 			(uint32x4_t)vcombine_u8((uint16x8_t)(_a_), (uint16x8_t)(_b_))
#define _mm_packus_epi16(  _a_,_b_) 			(uint32x4_t)vcombine_u8(vqmovun_s16((int16x8_t)(_a_)), vqmovun_s16((int16x8_t)(_b_)))
//---------------------------------------------- movemask ----------------------------------------------------------------------------------------------------------------------------
    #ifdef __aarch64__
static ALWAYS_INLINE uint8_t   mm_movemask_epi8s(uint8x8_t sv) { const uint8x8_t  m = { 1, 1<<1, 1<<2, 1<<3, 1<<4, 1<< 5, 1<< 6, 1<<7 }; return vaddv_u8(  vand_u8(             sv, m)); } //short version (8 bytes) ARM only
...
static ALWAYS_INLINE uint32_t  mm_movemask_epu32(uint32x4_t v) { const uint32x4_t m = { 1, 1<<1, 1<<2, 1<<3 };                           return vaddvq_u32(vandq_u32((uint32x4_t)v, m)); }
static ALWAYS_INLINE uint64_t  mm_movemask_epu64(uint32x4_t v) { const uint64x2_t m = { 1, 1<<1 };                                       return vaddvq_u64(vandq_u64((uint64x2_t)v, m)); }
    #else
